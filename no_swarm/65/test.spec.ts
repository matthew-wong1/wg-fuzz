...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-1.0, 1.0, 0.25, 0.75, -0.5, 0.75, -0.5, 0.5, -0.75, -0.25, 0.25, -0.5, 0.5, -0.25, 0.0, 0.0, 0.25, -0.5, -0.25, 0.0, 0.0, 0.5, -0.25, -1.0, -0.75, 0.5, 0.0, -0.5, 0.75, 1.0, -0.25, -0.25, -0.25, -0.75, 0.0, 1.0, 1.0, -0.25, 0.5, -0.25, -1.0, 1.0, 0.0, 1.0, 1.0, 1.0, -0.5, 0.0, -0.5, -0.5, 0.5, -0.5, 0.25, -0.75, 0.25, 0.5, 0.5, -0.5, -0.25, 1.0, 0.5, -0.75, -0.75, -0.25, -0.75, 0.0, 1.0, 0.5, -1.0, 0.0, 0.0, 1.0, -0.25, 0.75, 0.25, -0.5, 0.75, 0.75, -0.25, 0.5, -0.5, -0.75, -1.0, -0.75, -0.5, -0.25, 0.25, -0.25, -0.75, -0.5, -0.25, 0.5, 0.75, 0.75, -0.75, -0.25, 0.25, -0.25, 0.25, -0.75, ]);
    ...
    query202.destroy()
    compute_pass_encoder0030.setPipeline(compute_pipeline0033);
    render_pass_encoder2000.setViewport(0, 0, texture200.width / 2, texture200.height / 2, 0, 1);

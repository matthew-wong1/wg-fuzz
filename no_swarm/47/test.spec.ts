...
async function main(gpu: GPU) {
    ...
    device10.queue.writeBuffer(buffer105, 0, uint32_1011, 0, uint32_1011.length);

    compute_pass_encoder1011.dispatchWorkgroupsIndirect(buffer105, 0);

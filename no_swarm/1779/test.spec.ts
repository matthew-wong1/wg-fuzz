...
async function main(gpu: GPU) {
    ...
    const array1 = new Float32Array([-0.75, 0.5, 1.0, -0.5, -1.0, 0.75, -0.5, -1.0, 1.0, -0.5, -0.75, -0.5, 0.5, 0.5, 0.0, 0.0, -0.25, -0.25, -0.25, 0.75, 1.0, 0.0, 0.25, 0.0, -1.0, 1.0, -1.0, 1.0, -0.25, -0.5, 0.0, 0.0, -0.25, 1.0, -0.75, -0.75, 0.75, -0.75, 0.25, 0.0, 0.25, 0.75, 0.0, 0.75, -1.0, 0.0, -0.25, 0.75, -0.25, 0.25, 0.75, 1.0, -0.5, 0.75, -0.25, -1.0, -1.0, -0.25, 0.75, 0.5, 1.0, -0.25, -0.25, -0.25, 1.0, -1.0, -0.75, -0.5, -1.0, 0.25, -1.0, -0.75, -0.75, -0.75, -0.75, 0.5, -1.0, 0.5, -0.5, 0.5, -0.5, 0.25, -0.75, 0.75, -0.25, -0.5, -0.75, -1.0, 0.25, -1.0, 1.0, -0.75, -1.0, 0.25, 1.0, -0.25, 0.25, 0.0, -0.5, 0.0, ]);
    ...
    query003.destroy()
    compute_pass_encoder0001.setPipeline(compute_pipeline007);
    ...
    const compute_pass_encoder0002 = command_encoder000.beginComputePass({ label: "compute_pass_encoder0002" });
    ...
    compute_pass_encoder0002.setPipeline(compute_pipeline0013);
    ...
    compute_pass_encoder0002.insertDebugMarker("marker")
    ...
    compute_pass_encoder0002.setBindGroup(0, bind_group001);
    ...
    compute_pass_encoder0002.pushDebugGroup("group_marker")
    ...
    compute_pass_encoder0002.popDebugGroup()
    texture001.destroy();
    ...
    const array3 = new Float32Array([-0.25, 0.75, 0.0, 0.25, 0.5, -0.5, 1.0, -0.75, -0.75, 1.0, -0.5, 1.0, 0.5, 0.0, -0.5, 1.0, 0.25, 0.25, -0.25, 0.0, 0.75, -0.25, -0.75, -0.25, -0.75, 1.0, 0.5, 0.75, -0.25, 0.25, 0.0, 0.5, 0.25, 0.75, -0.75, -1.0, 1.0, -1.0, -1.0, -0.75, 0.75, 0.0, 0.75, -0.5, 1.0, 0.5, 0.25, 0.25, 0.5, 0.5, 0.25, 0.0, 0.0, -1.0, -0.75, 0.25, 0.25, 1.0, 1.0, 0.0, -0.75, -0.5, 0.0, -1.0, -0.25, 1.0, -0.5, 1.0, 0.5, 0.75, 0.0, 0.75, 0.5, 0.25, -0.25, 0.75, -1.0, -1.0, -0.5, 0.5, -0.5, -0.25, -0.5, 0.0, 0.25, 0.5, 0.75, 1.0, -0.5, -0.25, -0.75, -0.75, 0.0, -1.0, -0.75, -0.75, -0.75, -0.5, -0.5, 1.0, ]);
    ...
    compute_pass_encoder0002.insertDebugMarker("marker")
    const uint32_0002 = new Uint32Array(3);
    ...
    device00.queue.writeBuffer(buffer009, 0, uint32_0002, 0, uint32_0002.length);

    compute_pass_encoder0002.dispatchWorkgroupsIndirect(buffer009, 0);
    ...
    device00.queue.writeBuffer(buffer0015, 0, uint32_0002, 0, uint32_0002.length);

    compute_pass_encoder0002.dispatchWorkgroupsIndirect(buffer0015, 0);

...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([0.75, -0.75, -0.75, 0.0, -0.75, -0.25, 0.75, -1.0, 0.5, 0.75, -1.0, 0.75, -1.0, 1.0, 0.25, 1.0, 1.0, 0.75, 0.0, 0.25, 1.0, 0.0, 0.5, 0.75, 1.0, 0.5, 0.25, 0.0, 0.0, 0.5, 0.25, 0.0, -0.25, -0.5, -0.25, 0.5, -1.0, 0.75, -0.25, -0.5, -0.75, 0.5, 0.25, -1.0, -0.75, -0.75, 0.0, 1.0, 0.75, 0.5, -0.75, -0.75, -1.0, -0.25, 0.75, 0.5, 0.75, -0.5, 0.75, 0.75, -1.0, -0.75, 0.5, -0.75, -0.75, 0.0, -0.25, -0.25, 0.25, 0.0, 0.5, -0.25, 0.5, -1.0, 0.75, 0.25, 1.0, -1.0, 0.75, -0.25, 0.0, 0.75, 1.0, 0.5, 0.25, 0.25, 0.25, 0.75, 0.75, 0.25, 0.25, 0.0, 0.0, -0.5, -0.25, 0.75, 0.0, 0.5, -0.5, 1.0, ]);
    const adapter0 = await gpu.requestAdapter({
        powerPreference: "high-performance"
    });
    const array1 = new Float32Array([-1.0, 0.25, -1.0, -0.5, -0.5, -0.5, 1.0, -1.0, -0.75, -0.25, -0.75, -0.75, -1.0, -0.25, -1.0, -1.0, 0.75, 0.25, -0.25, 0.75, 0.5, -0.25, 0.75, -0.5, 0.25, 0.75, 0.25, 1.0, 0.5, -0.25, 1.0, -1.0, 0.75, 0.25, -1.0, -1.0, -0.25, -1.0, -0.25, 0.5, -1.0, 1.0, -0.25, -0.25, 1.0, -0.5, -0.5, 0.0, -0.25, -0.25, 0.75, 0.0, 0.75, -1.0, 1.0, 0.0, -1.0, 1.0, 0.25, 0.5, 0.5, 0.75, 0.0, -0.25, -0.25, -1.0, -0.75, 0.0, -0.25, 0.0, 0.75, 1.0, 0.5, 1.0, -1.0, 0.25, 0.0, 0.0, 0.5, 0.0, 0.0, 0.75, -0.25, 0.5, -0.5, 0.0, -0.25, -0.75, -0.75, -1.0, 0.0, -0.5, 0.75, 0.0, 0.75, -0.25, -0.25, -0.75, 0.75, -1.0, ]);
    ...
    const array2 = new Float32Array([-0.5, 0.0, -0.25, 0.5, 0.0, -0.75, -1.0, -0.25, -0.5, -0.5, -1.0, -0.5, 0.75, 0.5, -0.25, -1.0, -0.75, 0.5, 1.0, -0.75, 0.5, -0.5, 0.75, -0.5, -1.0, -0.5, -1.0, 0.75, 0.75, -1.0, 0.75, 0.25, 0.5, 1.0, -0.5, -1.0, 0.75, 0.25, 0.5, 0.75, -1.0, -0.25, 0.25, 1.0, 1.0, 0.75, -0.5, 0.5, 1.0, 1.0, 0.25, 0.25, 0.5, 1.0, 0.75, -0.75, 1.0, 0.5, -0.5, -0.25, 0.75, 0.0, -0.25, 0.0, 0.75, 0.5, -0.25, 0.75, 1.0, -0.75, 0.0, -0.75, -0.75, -1.0, -0.5, -0.5, 0.25, 0.5, -0.5, -0.5, 1.0, -1.0, 0.0, -0.25, -0.25, 0.5, -0.25, 0.0, -1.0, 0.5, 0.5, -1.0, -0.75, 0.75, 0.5, 0.75, 0.25, -0.75, 0.25, -0.25, ]);
    ...
    const array3 = new Float32Array([0.75, -0.25, -1.0, 0.5, 0.0, 0.75, 1.0, 1.0, 0.5, 0.75, -0.5, 0.75, 0.25, -0.25, 0.75, -0.5, 1.0, 1.0, -0.5, -1.0, 0.5, 0.75, -1.0, -0.75, 0.0, -0.25, 0.75, 1.0, 0.25, 0.75, 0.5, 0.0, 1.0, 0.5, -1.0, 0.75, 0.5, 0.25, 0.25, 1.0, 1.0, 0.25, -0.75, 0.5, 0.0, -0.25, -0.5, 0.75, -0.75, -1.0, -0.75, -0.75, -0.75, -0.25, 0.25, -0.75, -0.25, 0.0, 1.0, 0.25, 0.5, 0.25, -0.5, -0.25, 0.5, -1.0, -0.5, 0.25, -0.5, 0.0, -0.5, 0.5, -0.25, 0.25, -0.25, -0.25, -1.0, -0.5, 0.0, 0.25, 0.25, -0.5, 0.25, 0.25, 1.0, -0.5, -1.0, 1.0, -1.0, 0.0, -1.0, 0.0, 0.5, 0.25, 0.5, 1.0, 0.75, 0.25, 0.75, 1.0, ]);
    ...
    render_bundle_encoder701.setPipeline(render_pipeline706);
    ...
    render_bundle_encoder702.setVertexBuffer(0, buffer705);
    ...
    render_bundle_encoder702.draw(3);
    ...
    const array4 = new Float32Array([0.75, -1.0, -0.75, 0.75, 0.0, 1.0, 0.75, 0.0, 0.25, -0.5, 0.0, 0.5, -1.0, -0.5, -0.5, -0.5, -0.25, -1.0, 0.0, 0.5, 1.0, 0.5, -0.75, 1.0, 0.25, -1.0, 1.0, -0.5, -1.0, -0.5, 0.5, 0.75, -0.5, 1.0, -0.75, -1.0, 0.0, 0.75, 0.0, -0.75, 1.0, 0.75, -0.25, 1.0, -0.25, 0.0, 1.0, 0.25, 0.0, 0.75, -0.5, 0.75, 0.5, 0.0, 0.5, -0.5, -0.5, 1.0, -0.75, 0.5, 0.25, 0.75, -1.0, 0.5, 0.0, 0.0, -0.75, 0.75, 0.75, 0.25, -0.25, -0.5, 0.0, 0.25, -1.0, 0.25, 0.5, 1.0, 0.5, 0.0, 0.75, 0.5, -0.5, -0.5, 0.25, 0.0, -0.75, 0.25, -0.5, -0.5, -0.25, 0.75, 1.0, 1.0, -1.0, 0.5, -0.5, 0.5, 0.25, -0.75, ]);
    render_bundle_encoder703.setPipeline(render_pipeline701);
    ...
    render_pass_encoder7020.setPipeline(render_pipeline706);
    
    render_bundle_encoder701.setVertexBuffer(0, buffer706);
    ...
    {
        await buffer709.mapAsync(
            GPUMapMode.READ,
            0,
            400,
        );
        
        const copyArrayBuffer = buffer709.getMappedRange(0, 400);
        const data = copyArrayBuffer.slice(0);
        buffer709.unmap();
        console.log(new Float32Array(data));
    }
    ...
    render_bundle_encoder701.setIndexBuffer(buffer702, "uint16");
    buffer7010.destroy()
    ...
    render_bundle_encoder701.draw(3);
    
    const texture_view7001 = texture700.createView({ label: "texture_view7001" });
    render_pass_encoder7021.popDebugGroup();
    
    render_pass_encoder7021.setPipeline(render_pipeline706);
    render_bundle_encoder300.pushDebugGroup("group_marker");
    render_pass_encoder7021.pushDebugGroup("group_marker");
    device70.queue.writeBuffer(buffer709, 0, array2, 0, array2.length);
    
    const texture_view2000 = texture200.createView({ label: "texture_view2000" });
    
    render_pass_encoder7021.setScissorRect(0, 0, texture700.width / 2, texture700.height / 2);
    ...
    render_pass_encoder7021.setBindGroup(0, bind_group704);
    render_pass_encoder7021.setVertexBuffer(0, buffer703);
    render_pass_encoder7021.setIndexBuffer(buffer7010, "uint16");
    ...
    render_pass_encoder7021.drawIndexedIndirect(buffer7011, 0);
    render_pass_encoder7021.drawIndexedIndirect(buffer7013, 0);
    render_pass_encoder7020.setVertexBuffer(0, buffer705);
    render_pass_encoder7020.drawIndirect(buffer7011, 0);
    command_encoder400.popDebugGroup()
    render_pass_encoder7020.end();
    render_pass_encoder7020.endOcclusionQuery()
    compute_pass_encoder7000.popDebugGroup()
    render_pass_encoder7020.popDebugGroup();
    render_pass_encoder7021.end();
    device70.popErrorScope().then((error) => {
        if (error) {
            console.error(`An error occurred: ${error.message}`);
        }
    ...
    device70.queue.submit([command_buffer702, ]);
    render_pass_encoder7021.drawIndirect(buffer7013, 0);
}
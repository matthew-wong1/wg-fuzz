...
async function main(gpu: GPU) {
    ...
    const array3 = new Float32Array([0.25, -0.25, -0.75, -0.25, 1.0, -0.75, -0.25, 1.0, -0.25, 0.75, -0.25, -0.75, 0.25, 1.0, -0.5, 0.5, -0.75, 0.0, 0.0, -0.5, 0.75, 0.5, -1.0, -0.5, -1.0, -0.25, 0.0, -1.0, 0.25, 0.75, 0.0, 0.75, 0.75, -0.25, -0.5, -1.0, 0.25, 0.0, -0.25, 0.25, 0.25, -0.25, 0.75, -0.75, -0.75, 0.0, -0.75, -1.0, -0.75, -0.25, -1.0, 1.0, -0.5, -0.25, 0.25, 1.0, 0.5, -1.0, 0.5, -0.25, -1.0, -1.0, 0.25, -1.0, 0.75, 0.5, 1.0, -0.75, 0.0, -0.25, 1.0, 0.0, -0.5, -0.75, 0.0, 1.0, 1.0, -0.75, -0.5, -0.5, -0.25, 0.75, -0.25, 1.0, 0.25, 0.75, 0.25, -1.0, 0.0, 1.0, -1.0, -1.0, 0.0, -0.5, -0.75, 0.25, -0.5, 1.0, -0.5, -0.25, ]);
    ...
    const array4 = new Float32Array([0.75, 0.0, 0.0, -0.75, 0.75, -0.5, 0.0, 0.75, 0.25, 0.5, -1.0, 1.0, -0.25, 0.5, 0.75, 1.0, 0.5, 0.25, 0.25, -0.25, -1.0, 0.75, 0.75, 0.25, 1.0, 0.25, 0.0, 0.0, 1.0, 0.25, 0.5, 0.0, -0.25, 0.5, -0.5, 1.0, 0.0, 0.25, -0.25, 1.0, 1.0, -0.25, -0.5, -0.75, -1.0, 0.0, -0.25, -0.25, 0.25, -0.75, 1.0, -0.75, 0.0, 1.0, 0.75, 0.5, 1.0, 0.5, -0.25, -0.75, 0.0, -0.5, 0.0, 0.25, -0.5, -0.75, 0.75, 0.75, -0.75, 0.75, -0.75, 0.5, 0.5, -0.5, 1.0, 0.5, -1.0, -0.5, 0.25, 0.75, -0.25, 0.25, -1.0, 0.5, 0.75, -1.0, 0.75, 1.0, -0.75, 0.0, 0.75, 0.0, 0.5, -0.25, 0.25, -0.75, 0.25, -1.0, 0.5, 0.75, ]);
    render_pass_encoder1030.setStencilReference(1);
    query100.destroy()
    render_bundle_encoder100.insertDebugMarker("marker");
    ...
    render_pass_encoder4021.drawIndexedIndirect(buffer402, 0);
    render_pass_encoder4020.popDebugGroup();
    compute_pass_encoder4010.popDebugGroup()
    device30.queue.submit([]);
    device30.queue.submit([]);

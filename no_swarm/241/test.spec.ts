...
async function main(gpu: GPU) {
    ...
    const array1 = new Float32Array([0.25, 0.5, -1.0, -1.0, 0.25, 0.25, 0.25, -0.75, 0.0, 1.0, -0.25, 0.5, 0.75, 0.0, 1.0, 0.75, -0.25, 0.5, 1.0, 0.5, 0.5, 0.5, 0.0, -0.5, 0.0, 1.0, 0.0, 0.75, 0.75, -1.0, 0.5, 0.75, 0.75, -0.5, 1.0, 0.0, 0.25, 0.5, -0.75, 0.25, -0.25, 0.25, -0.5, -0.75, 1.0, 0.75, -1.0, 0.0, 0.0, 1.0, -0.25, 0.75, 0.0, -1.0, -0.75, -0.25, 0.5, -1.0, -1.0, -0.5, -0.25, 0.75, -1.0, 0.25, -0.5, 0.25, 0.5, 0.75, -0.75, -0.5, -1.0, -0.25, 0.25, -0.75, 1.0, 0.5, 1.0, 0.5, 0.25, 0.25, -0.25, 0.25, -0.5, 0.5, 0.75, 0.0, -0.75, 0.0, -0.75, 1.0, 0.5, 0.0, -0.25, 0.0, -0.25, 0.5, 0.5, 1.0, 0.75, 1.0, ]);
    ...
    render_pass_encoder00100.setPipeline(render_pipeline004);
    ...
    render_pass_encoder0090.setVertexBuffer(0, buffer003);
    ...
    render_pass_encoder00100.setVertexBuffer(0, buffer003);
    ...
    device00.queue.submit([command_buffer004, command_buffer007, command_buffer0010, ]);
    ...
    device00.queue.submit([command_buffer000, command_buffer003, command_buffer005, command_buffer009, ]);
}
...
async function main(gpu: GPU) {
    ...
    query000.destroy()
    const array1 = new Float32Array([0.75, 0.75, 0.0, 1.0, -1.0, 0.25, -0.25, -1.0, 0.25, -1.0, 0.0, -1.0, -0.75, 0.25, 0.0, 0.0, -0.25, 0.25, 1.0, 0.75, 1.0, -0.25, -0.75, 1.0, 0.25, 0.0, 1.0, -0.75, 0.5, -0.25, 0.75, -0.75, 0.0, -0.75, -0.75, -0.25, 0.0, 0.0, -0.5, -1.0, 0.75, -0.75, 1.0, -0.5, -1.0, -1.0, -0.75, 0.0, -0.25, -0.75, 0.25, -0.75, 1.0, 0.25, -0.75, 0.5, -1.0, 0.75, 0.5, 0.75, -0.5, -0.25, -0.5, 0.75, 0.5, -1.0, 0.0, -0.75, 0.0, 1.0, -1.0, 0.75, 0.0, -1.0, -0.75, -0.75, 0.75, 0.5, 0.5, 1.0, 0.25, 0.75, 0.75, -0.25, -0.5, -0.25, -0.75, -0.25, 0.75, 0.5, -0.25, -0.25, 1.0, 0.25, 0.5, 0.0, -0.25, 0.5, 0.5, -0.5, ]);
    ...
    compute_pass_encoder0000.setPipeline(compute_pipeline0020);
    ...
    const array3 = new Float32Array([1.0, 0.5, 1.0, 0.0, 0.75, 0.0, -1.0, 0.25, -0.75, -0.5, -0.75, 0.75, 0.5, 0.0, 0.75, 0.5, -0.5, 0.75, -0.75, 0.75, 1.0, -0.5, 0.5, -1.0, 0.25, -0.5, -0.5, 0.0, -0.25, 0.75, 0.0, 1.0, 1.0, -0.75, 1.0, -0.5, 0.0, 0.0, -0.5, 0.0, -0.25, -0.25, 0.75, 0.0, 1.0, 0.25, 0.5, -0.5, 0.25, 0.25, 1.0, -0.5, -0.25, -0.25, -0.25, -0.75, 0.0, 0.5, 0.0, -0.75, 0.25, -1.0, 1.0, -1.0, 0.25, 0.75, -1.0, 0.25, 0.0, 0.25, -1.0, -1.0, 1.0, 0.0, 0.5, 0.25, 0.25, 0.25, 0.5, 0.5, 1.0, 0.25, 0.75, -1.0, -1.0, -0.75, 0.0, -1.0, 0.25, 1.0, 0.75, -1.0, 1.0, -1.0, -0.75, -0.5, -0.25, 0.0, -1.0, 0.75, ]);
    ...
    render_pass_encoder1020.setBlendConstant([1.0, 0.0, 0.0, 1.0]);
    compute_pass_encoder0020.setPipeline(compute_pipeline0032);

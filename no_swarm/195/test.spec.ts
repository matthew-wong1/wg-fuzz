...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-0.25, 0.25, 1.0, 0.0, -0.25, -0.5, 0.25, 0.5, 0.5, -0.25, -0.25, -0.25, -1.0, 1.0, 1.0, 0.0, 0.75, 0.75, -0.5, -0.25, 0.75, -1.0, 0.0, -0.25, 0.75, 0.0, -1.0, -0.75, -0.5, 1.0, 0.75, -0.25, -1.0, 0.25, -0.5, 0.75, -0.5, 1.0, -1.0, -0.5, 0.0, 0.25, 0.75, 0.75, 0.5, -0.5, -0.75, -0.75, 0.0, -0.25, 0.5, 1.0, 0.0, -0.75, 0.0, -1.0, 0.0, -0.75, -1.0, 0.75, 0.5, -1.0, -0.25, 0.0, 0.75, -0.75, -0.5, 0.25, -1.0, 0.0, -0.75, 0.25, -0.25, 0.5, -0.5, -1.0, -0.25, 0.75, -0.25, 0.0, 0.5, -1.0, 0.25, -0.75, 0.75, 0.0, -1.0, -0.75, 0.0, -0.5, 0.75, -0.75, -1.0, 0.75, -0.75, -0.25, 0.5, -0.25, -0.75, -0.25, ]);
    ...
    const array3 = new Float32Array([-0.75, 0.0, 0.5, 1.0, -0.75, 1.0, 0.75, 0.0, -0.5, 0.25, -1.0, 0.25, -0.5, -1.0, -0.25, -0.5, -0.25, 0.5, -0.75, -1.0, -1.0, 0.5, -0.5, -0.25, -1.0, 0.25, -0.25, 0.5, 0.0, -0.25, 0.0, -0.25, 0.25, 0.5, -0.25, 1.0, 1.0, -1.0, -0.25, 0.0, -0.25, 0.75, -0.75, -0.25, -0.75, 0.5, -1.0, 0.25, 0.5, 1.0, -1.0, -0.5, 0.25, 1.0, -0.5, 1.0, -0.25, -0.25, -0.5, -0.25, 0.0, -1.0, -0.25, 0.5, 0.75, 0.5, -0.5, 0.25, 0.5, 0.0, 0.75, -0.5, -0.25, 0.5, 1.0, -0.5, -0.25, -1.0, -0.75, -0.5, -0.25, -1.0, -1.0, 0.0, -0.25, -0.75, 0.5, 0.0, -0.5, 0.75, -0.5, 0.75, 0.0, 0.25, 0.25, 0.25, 0.5, -0.5, 0.75, -1.0, ]);
    ...
    compute_pass_encoder0060.setPipeline(compute_pipeline0022);
    ...
    device00.queue.writeBuffer(buffer0016, 0, uint32_0060, 0, uint32_0060.length);

    compute_pass_encoder0060.dispatchWorkgroupsIndirect(buffer0016, 0);

...
async function main(gpu: GPU) {
    const array0 = new Float32Array([0.25, 0.75, 0.0, -0.75, -0.25, -0.75, -1.0, 1.0, -0.25, -1.0, 0.0, 0.0, -0.75, 0.25, -0.75, -0.75, 0.75, 0.75, 0.0, -0.25, 0.75, 0.25, -0.25, 0.0, 0.25, 1.0, 1.0, 0.75, 0.5, -0.25, -1.0, 0.75, -0.75, -0.5, -0.5, 0.75, -0.5, 0.75, 1.0, 0.0, 1.0, 0.25, 0.5, 0.5, 1.0, 0.5, -0.5, -0.5, 0.0, -0.75, -0.25, 0.5, -0.25, -0.75, 0.25, 0.5, 0.0, 0.25, 0.75, 0.0, -0.75, 0.25, -0.75, 0.75, 0.5, -0.75, -0.75, -0.5, 0.5, -0.25, 0.25, -1.0, 1.0, -0.5, 0.5, -0.25, -0.5, 0.75, -1.0, -1.0, -1.0, -1.0, -0.5, -0.25, 1.0, 0.0, -0.25, 0.75, -0.75, -1.0, -0.5, 0.75, -0.5, 0.5, 0.0, -0.5, 0.75, 0.0, -1.0, -0.5, ]);
    ...
    const array1 = new Float32Array([0.0, 0.25, 0.0, -0.75, 0.75, 1.0, 1.0, -0.25, -0.25, -0.25, 0.5, 0.0, -0.25, 0.0, 0.5, 0.5, 0.25, 0.75, 0.75, -0.75, -0.75, -0.25, 1.0, 0.75, 0.0, 1.0, -0.5, -0.25, 0.0, -0.25, -1.0, -1.0, -0.5, 0.75, -0.25, 0.25, 0.25, -1.0, 0.25, -0.25, 0.25, 0.5, 1.0, 0.25, -0.5, -0.5, 0.5, 0.25, 0.5, -0.25, 0.5, 0.0, 0.75, 0.25, -0.25, -0.25, 0.25, 0.75, 0.75, 0.75, 0.5, 0.5, -0.5, 0.25, -0.5, 0.25, 0.5, 0.5, 0.0, -0.25, -0.5, 0.25, 0.0, -0.75, -0.25, -0.75, -0.5, -0.5, 0.25, -0.25, 0.5, 0.75, 1.0, 0.5, -1.0, -0.5, 0.25, 0.25, 0.5, 0.5, -0.25, 0.75, 0.5, -0.75, 0.75, -0.75, -0.5, 1.0, 0.5, -0.5, ]);
    ...
    const array3 = new Float32Array([0.75, 0.0, 0.0, -0.5, 0.75, -0.25, 1.0, 0.25, -1.0, -0.25, 0.0, -0.75, 1.0, -0.25, -0.75, -1.0, -1.0, 0.0, -1.0, 0.75, 1.0, 0.75, 0.25, -0.5, 1.0, -1.0, -1.0, -0.5, -0.75, -0.25, 0.25, 0.5, 1.0, -0.75, -0.75, -0.5, 0.0, 0.0, -0.25, -0.75, -0.25, 0.25, -0.5, 1.0, 0.25, 1.0, -0.75, 0.75, 0.5, -0.5, 0.75, -0.75, 0.25, 0.25, -0.75, 0.75, 0.25, 0.25, -0.75, 0.75, 0.25, 0.25, 0.75, -1.0, 0.25, 0.25, 1.0, 0.25, -0.25, 0.0, 0.25, 0.25, -1.0, -0.25, 0.25, 0.5, 0.75, 0.25, -1.0, -0.5, 0.5, 0.25, 0.25, -0.5, 1.0, 0.0, -1.0, -0.25, -0.75, -1.0, -0.5, 0.25, 0.25, -0.25, 1.0, -0.25, 0.25, -0.5, 1.0, 0.75, ]);
    ...
    device00.destroy();
    render_bundle_encoder201.drawIndexedIndirect(buffer200, 0);
    render_pass_encoder2030.insertDebugMarker("marker");
    buffer204.destroy()
    device20.queue.submit([command_buffer202, ]);
    
    render_pass_encoder2032.setPipeline(render_pipeline201);
    ...
    render_pass_encoder2032.setBindGroup(0, bind_group203);
    ...
    render_pass_encoder2032.setVertexBuffer(0, buffer205);
    render_pass_encoder2032.drawIndirect(buffer208, 0);

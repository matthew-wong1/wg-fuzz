...
async function main(gpu: GPU) {
    ...
    const array1 = new Float32Array([-0.25, -0.5, 0.75, -0.5, -0.5, 1.0, 0.25, 0.0, 0.75, -0.75, 0.0, 1.0, -1.0, -0.5, 1.0, -1.0, -0.5, 0.75, 1.0, 0.25, 0.0, 0.5, -0.75, -0.5, 0.0, -0.25, -0.75, 0.5, -0.25, 0.0, 0.75, -1.0, -0.25, 1.0, -0.25, 0.5, -0.5, -0.25, -1.0, 1.0, 0.5, 0.75, 0.0, 1.0, -0.5, 1.0, 0.75, 1.0, 0.25, 0.5, -1.0, -1.0, 1.0, 0.5, 0.5, -0.5, 0.5, 1.0, 0.75, 0.75, -1.0, 0.0, 0.75, -0.25, 0.0, -1.0, -1.0, -0.25, -0.25, -1.0, 0.75, 0.75, 0.25, -0.25, 0.0, -0.75, 1.0, 1.0, -0.25, 0.25, 0.5, 0.25, -0.75, 0.5, -0.25, 1.0, 0.5, -0.25, -1.0, -0.5, -1.0, 0.25, 0.0, -0.75, -1.0, -0.25, -1.0, -1.0, 0.0, -0.25, ]);
    ...
    const array2 = new Float32Array([0.5, -0.5, 0.0, -0.5, -0.5, -0.75, 0.25, -1.0, -1.0, -0.75, 0.75, 0.25, 0.0, 0.25, 0.0, -1.0, -0.5, 0.5, -0.5, 0.5, 0.75, 1.0, -0.75, -0.75, -1.0, 0.75, -1.0, -1.0, -1.0, 0.5, -0.75, -0.25, 0.0, -1.0, 0.25, -0.75, 0.0, 1.0, 0.0, 0.5, -0.5, -0.25, 0.25, 0.0, -0.75, 0.75, 0.25, 0.75, -1.0, 0.75, 0.5, -1.0, -0.25, 0.75, -0.25, 1.0, 1.0, 0.5, -0.75, 0.0, 0.0, 0.25, 0.25, -1.0, -0.75, 0.5, -0.5, 0.75, 0.5, 0.75, 0.75, -0.25, -0.25, 1.0, 0.5, 0.5, -1.0, -0.25, -0.25, -1.0, 0.5, 1.0, 0.0, 0.5, -0.5, -1.0, 0.75, 1.0, 1.0, -0.5, 0.0, -0.25, 0.25, 1.0, -0.25, 0.75, -1.0, -1.0, -0.25, 0.25, ]);
    ...
    compute_pass_encoder0020.setPipeline(compute_pipeline0073);
    ...
    const bind_group001 = device00.createBindGroup({
        label: "bind_group001",
        layout: compute_pipeline0073.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {

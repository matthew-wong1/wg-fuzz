...
async function main(gpu: GPU) {
    ...
    render_pass_encoder1000.insertDebugMarker("marker");
    const array2 = new Float32Array([-0.5, -1.0, 0.75, -0.75, 0.25, -0.25, -1.0, 0.0, 0.75, -1.0, -0.75, -1.0, 0.5, 0.0, 0.25, 0.5, 1.0, 0.25, -0.75, 1.0, 0.0, -1.0, -0.25, 0.75, 0.5, -0.25, 0.0, 0.5, -0.75, 0.0, -0.25, -0.25, -0.5, -0.75, -0.25, 1.0, 0.25, -0.75, 0.75, 1.0, 0.0, -0.5, 0.75, -0.75, -0.75, -0.5, -0.75, -0.5, 0.5, 0.75, -1.0, 1.0, -0.25, 0.5, -0.5, 0.75, 1.0, -1.0, 1.0, 0.25, -0.5, 0.0, 0.5, -0.75, 0.0, 0.0, 1.0, -1.0, -0.25, -1.0, -0.25, 0.5, -0.25, -1.0, -0.25, 1.0, 1.0, 0.0, 1.0, 0.5, -1.0, 0.25, 0.25, -0.5, 0.5, 0.0, 0.0, -0.75, 0.25, 0.0, 0.0, 0.5, 1.0, 1.0, -0.5, -0.25, -0.5, -0.75, 0.0, -0.75, ]);
    ...
    compute_pass_encoder1011.setPipeline(compute_pipeline1013);
    ...
    render_bundle_encoder102.setVertexBuffer(0, buffer1015);
    render_pass_encoder1031.setBlendConstant([1.0, 0.0, 0.0, 1.0]);
    render_pass_encoder1020.setStencilReference(1);
    ...
    render_pass_encoder1021.setBindGroup(0, bind_group1013);
    ...
    device10.queue.writeBuffer(buffer1064, 0, uint32_1011, 0, uint32_1011.length);

    compute_pass_encoder1011.dispatchWorkgroupsIndirect(buffer1064, 0);
    ...
    render_pass_encoder1021.setIndexBuffer(buffer1058, "uint16");

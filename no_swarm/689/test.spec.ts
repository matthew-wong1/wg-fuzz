...
async function main(gpu: GPU) {
    const array0 = new Float32Array([-0.75, 1.0, 0.75, 0.0, 0.25, 0.5, 0.5, 0.25, 0.0, 1.0, 0.0, -1.0, 0.25, -0.5, -0.25, -1.0, -0.5, -0.75, -1.0, 0.75, -0.25, 0.25, 0.5, 0.5, 0.25, 1.0, 0.75, 0.25, -0.25, 1.0, -1.0, 0.75, 0.0, 1.0, 0.75, -0.25, 0.5, 1.0, -0.25, 1.0, 0.25, -0.75, 1.0, 1.0, 0.75, -0.75, 1.0, -1.0, -0.75, -0.25, -0.25, -1.0, 0.5, -0.25, -0.25, -0.75, -0.75, -0.5, 0.0, 0.0, 1.0, -1.0, 0.75, 0.5, 1.0, 0.5, -0.75, -0.25, -0.75, 0.25, -0.75, 0.75, 1.0, -1.0, -0.25, 0.75, -0.25, -0.25, -0.75, -0.75, -0.5, 1.0, -0.25, 0.0, -0.25, -0.5, 1.0, -0.75, 0.0, -0.5, 0.5, -0.5, 0.0, -0.25, -0.25, 0.0, -0.5, -0.5, -0.25, -0.75, ]);
    ...
    const array1 = new Float32Array([-0.75, -1.0, 1.0, -1.0, -0.25, 0.5, 0.0, 0.25, -0.5, -0.75, 0.5, -0.25, 0.75, 0.0, -1.0, -0.75, 0.25, 1.0, -1.0, 0.25, 1.0, 0.0, -0.75, -0.5, -0.75, -1.0, 0.25, 0.0, -0.5, 0.5, -0.5, -1.0, 1.0, -0.5, -0.5, -1.0, 0.75, -0.25, 1.0, -0.25, -1.0, -1.0, 1.0, -1.0, 0.75, 1.0, -1.0, -0.75, 0.0, 1.0, 0.75, 0.0, -0.5, 0.25, -1.0, -1.0, 0.0, -1.0, -0.5, 0.5, 0.75, -0.5, 0.75, 0.25, 0.0, 0.25, 0.25, 1.0, -0.5, -1.0, 1.0, 0.0, 0.25, -0.5, 0.0, 0.5, 1.0, 0.75, -0.25, 0.25, -1.0, -0.75, 0.0, 1.0, 0.25, 0.25, 1.0, -0.5, -0.75, 1.0, 0.5, -1.0, 1.0, 0.0, 0.5, -0.75, -0.25, -0.75, -1.0, 0.0, ]);
    ...
    const array2 = new Float32Array([-1.0, 0.0, -1.0, -1.0, 0.5, -1.0, -1.0, 0.0, 0.25, 0.75, 0.5, 0.75, 0.5, -0.75, 0.25, 0.5, -1.0, -0.5, 1.0, 0.5, 0.5, -1.0, 0.5, 0.25, 0.75, -0.75, -0.75, 0.5, -1.0, 1.0, 0.5, 1.0, -0.25, 0.75, -0.5, -0.5, -0.5, 0.5, 0.75, 0.25, 0.0, 0.25, -0.75, 0.0, -0.75, -0.5, 1.0, -1.0, -0.25, 0.0, -0.25, -0.75, -0.5, 1.0, -0.5, 0.5, -1.0, 0.0, 1.0, 1.0, 0.5, 0.25, -0.5, 0.5, 0.5, 0.0, 0.25, -0.5, -0.25, 0.0, 1.0, 0.0, -0.5, -1.0, 0.5, 0.5, -1.0, -0.75, -0.5, 0.0, 0.0, -0.5, 0.0, 0.25, -0.25, -0.25, -0.75, 0.0, 0.5, 0.5, 0.75, 0.5, 0.5, 0.5, 0.5, -1.0, -1.0, -0.5, -0.75, -0.25, ]);
    ...
    compute_pass_encoder0000.insertDebugMarker("marker")
    query000.destroy()
    compute_pass_encoder4050.setPipeline(compute_pipeline403);
    render_bundle_encoder400.pushDebugGroup("group_marker");
    ...
    render_bundle_encoder401.insertDebugMarker("marker");
    compute_pass_encoder4031.setPipeline(compute_pipeline406);
    ...
    device40.queue.writeBuffer(buffer4014, 0, uint32_4031, 0, uint32_4031.length);

    compute_pass_encoder4031.dispatchWorkgroupsIndirect(buffer4014, 0);
    render_pass_encoder0010.endOcclusionQuery()
    ...
    compute_pass_encoder4050.setBindGroup(0, bind_group405);
    const command_buffer401 = command_encoder401.finish();
    compute_pass_encoder4050.dispatchWorkgroups(100);
    compute_pass_encoder4050.end();
    device40.queue.submit([command_buffer401, command_buffer402, command_buffer404, command_buffer406, ]);
    device00.popErrorScope().then((error) => {
        if (error) {
            console.error(`An error occurred: ${error.message}`);
        }

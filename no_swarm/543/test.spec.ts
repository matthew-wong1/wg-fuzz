...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-0.75, 1.0, 1.0, 0.0, 0.25, 0.0, -1.0, -1.0, 0.5, 1.0, -0.5, -0.5, -0.75, -0.25, 0.25, -0.5, -1.0, -1.0, 0.75, 0.5, -1.0, -0.75, -0.25, 0.0, -0.75, 1.0, -0.25, 0.0, -0.25, 0.5, -0.25, 0.25, 0.25, -1.0, 0.5, -0.5, 0.0, 0.5, -0.5, 0.25, 1.0, -0.25, 0.25, -0.5, 0.5, 0.75, -1.0, 1.0, -0.5, -0.75, 0.25, 0.0, 0.75, 0.75, -0.25, 0.0, 0.75, -0.5, -0.5, 0.75, -0.5, -0.75, 0.75, 0.25, -0.25, -1.0, -0.25, 0.0, -0.25, 0.0, 0.25, -0.25, -0.75, 1.0, -0.25, -0.75, 0.5, -0.75, -0.25, 0.5, 0.5, -0.5, 0.5, -1.0, 0.75, 0.0, -0.25, 1.0, -0.75, 0.75, 1.0, -0.75, 1.0, 0.0, -0.25, -0.25, 0.75, -1.0, 0.5, 0.5, ]);
    ...
    const array3 = new Float32Array([-0.5, 0.0, 0.25, -0.75, -1.0, -0.75, 0.75, -0.75, -1.0, 1.0, 0.0, -0.5, -0.25, -0.25, 1.0, 0.75, -1.0, -1.0, -0.5, 0.0, 0.5, 1.0, -0.5, 1.0, -1.0, -0.25, 1.0, 1.0, -1.0, 0.0, -0.75, 1.0, -0.5, -0.25, 0.0, 0.5, -0.25, 0.5, 0.5, 0.5, 0.25, 0.75, 0.0, 0.25, 0.75, 0.25, -0.75, -0.5, 0.0, 0.75, 1.0, -0.5, -0.25, 0.5, 0.25, 0.5, -0.5, 0.25, -0.25, 0.25, -0.25, -1.0, 0.75, 1.0, -1.0, -0.75, -0.25, 0.75, -0.5, 0.75, 0.0, 0.5, 0.0, -0.5, 1.0, 0.5, -0.25, 0.0, -1.0, 0.75, -0.75, -0.75, 0.75, -0.75, 1.0, 0.25, 0.5, 1.0, 0.5, 0.5, -0.75, 0.0, -0.25, -0.5, -0.25, 0.0, -1.0, -0.25, -0.25, -0.75, ]);
    ...
    compute_pass_encoder0070.setBindGroup(0, bind_group001);
    device00.queue.writeTexture({ texture: texture002 }, array4, { bytesPerRow: 40, rowsPerImage: 10 }, { width: 10, height: 10 });
    render_bundle_encoder302.insertDebugMarker("marker");

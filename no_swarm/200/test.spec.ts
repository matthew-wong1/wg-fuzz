...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([0.75, -1.0, 0.25, 0.25, 0.5, 0.75, -0.75, 0.25, 0.25, -0.25, 0.5, 0.5, 0.0, 0.25, -0.25, -0.5, -0.75, -0.25, -0.25, 0.25, 0.75, 0.5, -1.0, -0.75, -0.25, -1.0, 1.0, -1.0, 0.25, -0.25, -0.75, 0.0, 0.5, 0.5, 0.75, -1.0, -0.75, 0.5, 0.75, 1.0, 0.5, 1.0, -0.75, -0.25, 0.5, 1.0, 1.0, -1.0, -0.75, 0.25, 0.25, 0.5, 0.25, -0.25, 1.0, -0.75, -1.0, 0.75, 0.5, 1.0, -0.5, -1.0, 1.0, 0.25, -0.25, 0.5, 0.25, 1.0, -0.5, 0.75, -0.75, -0.25, -0.25, 0.25, 1.0, 0.0, -1.0, -1.0, -0.25, 1.0, -0.25, -0.5, -0.75, 0.75, 0.5, -0.5, -0.25, 0.75, 0.25, -0.5, 0.75, 0.0, 0.25, 0.25, 0.0, 0.5, -1.0, -0.25, -0.75, -0.5, ]);
    
    
    const device00 = await adapter0!.requestDevice({ label: "device00" });
    
    const array1 = new Float32Array([-1.0, -0.25, 0.25, 0.25, 0.25, -0.25, 1.0, 1.0, 0.25, 1.0, 0.0, -0.5, 0.25, 0.25, 0.5, -1.0, -0.25, 0.0, 1.0, -0.25, 0.25, -0.5, -1.0, 0.75, -0.75, 0.75, 0.5, 1.0, -0.75, 0.5, -1.0, 1.0, 0.5, -0.75, 0.5, 0.75, 1.0, 0.5, -0.75, 1.0, -0.25, 0.0, 0.0, 1.0, -1.0, 0.75, -1.0, 1.0, -0.75, -0.5, 0.25, 0.5, 0.25, -0.25, -0.75, -0.25, 0.5, 0.25, 0.75, -0.75, 0.75, -1.0, 1.0, -0.5, 0.75, 0.25, -0.25, -0.25, -1.0, 0.5, -0.75, -0.25, 0.75, -0.75, -1.0, -0.75, 0.0, 0.0, -0.5, 1.0, 0.75, 0.5, -1.0, 1.0, 0.5, -1.0, -0.75, -1.0, 0.25, 0.0, 1.0, -1.0, -1.0, -0.75, -0.5, -0.75, 0.5, 0.25, -0.75, -0.75, ]);
    ...
    const array3 = new Float32Array([-1.0, 0.5, 0.75, 0.25, 0.75, -1.0, 1.0, 0.75, -0.25, 0.25, 0.75, 0.75, -0.25, 0.5, 0.5, 1.0, -0.25, 0.25, 0.75, -0.25, -0.75, 0.5, 0.75, -0.75, -1.0, 0.5, -0.5, -0.5, -0.5, 0.0, -1.0, -0.25, 0.0, -1.0, -1.0, -0.5, 1.0, 1.0, -0.75, 0.75, 0.75, 0.75, -0.5, 0.0, -0.25, 0.25, -1.0, -0.25, 0.75, 1.0, -0.5, -0.25, -0.5, 1.0, -1.0, -1.0, -0.5, -1.0, -1.0, 0.5, 1.0, 0.0, 0.5, 0.25, 0.25, -0.75, 0.25, 0.25, 1.0, 0.0, -1.0, 0.25, -0.5, -0.75, 1.0, 0.75, -0.75, 0.5, -0.75, -1.0, -1.0, 1.0, 0.25, 1.0, 0.75, 1.0, -0.5, 0.5, -0.5, -0.75, 0.0, 0.5, -0.25, 0.5, 0.0, 0.25, -0.5, -1.0, -0.5, 0.5, ]);
    ...
    compute_pass_encoder1030.setPipeline(compute_pipeline1025);
    ...
    compute_pass_encoder1060.setPipeline(compute_pipeline1043);
    ...
    const bind_group104 = device10.createBindGroup({
        label: "bind_group104",
        layout: compute_pipeline1043.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {
    ...
    const array5 = new Float32Array([0.25, 0.5, -1.0, 0.25, 0.5, 0.75, 0.75, -0.75, -0.5, -0.5, -0.25, -1.0, -0.25, -1.0, 1.0, -1.0, 1.0, 0.25, 0.0, -0.75, 0.5, -1.0, 0.0, 0.75, -0.75, 0.0, 0.5, -0.25, -0.75, -1.0, 1.0, -0.5, -0.25, -0.25, 1.0, -0.25, -1.0, 0.5, -0.25, -1.0, 0.75, 1.0, 0.5, 0.5, 0.25, 0.5, -1.0, 0.5, 0.0, -0.25, -0.5, -1.0, -0.5, 1.0, -1.0, 0.25, -1.0, 0.75, -0.25, -0.5, 0.5, 1.0, -0.5, -0.25, 0.75, 1.0, 0.0, -0.5, 0.0, -0.75, 1.0, -0.25, 0.75, 0.5, 0.25, -0.5, -0.75, 0.5, 0.75, 0.75, 0.0, 0.75, 0.25, -0.5, 1.0, -0.5, 0.75, 0.25, -0.75, 0.5, -1.0, -0.75, 0.75, 0.75, -0.75, 0.75, 1.0, 0.75, 0.75, -1.0, ]);

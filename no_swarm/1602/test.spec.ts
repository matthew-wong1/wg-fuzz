...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-0.5, -0.5, 0.25, 0.25, 0.25, -0.75, -0.5, 0.5, 0.75, -0.5, 1.0, -0.25, 0.25, -0.5, -1.0, 0.5, -0.5, 1.0, -0.5, 0.25, 0.75, -1.0, -0.5, 0.75, -0.5, 0.5, -1.0, 0.25, -1.0, -0.25, -0.25, 0.0, -1.0, -0.25, -1.0, -0.5, 1.0, 0.5, 0.5, 0.75, 0.75, -0.75, -0.5, -0.75, 0.0, 0.0, 1.0, 1.0, -0.5, -0.75, -0.75, 0.75, -0.25, 1.0, -0.5, 0.5, -0.5, -0.75, -0.5, 1.0, 0.0, -1.0, -0.75, 0.25, 0.75, 0.25, 0.0, -0.25, 0.25, 0.5, -1.0, 0.5, -0.25, -0.25, -0.25, -1.0, 0.25, 0.5, 0.5, -0.25, -1.0, -0.75, -0.25, 1.0, -0.75, 0.5, 0.75, -0.25, 1.0, -0.75, 0.0, 0.5, 0.0, -0.75, -0.5, -1.0, -1.0, 0.5, 0.75, -1.0, ]);
    ...
    const array1 = new Float32Array([1.0, 0.0, 0.5, 0.25, 1.0, -1.0, -0.5, -1.0, 0.5, 0.5, 0.75, -0.25, -1.0, 0.25, 0.75, 1.0, 0.0, -0.5, -0.25, 0.5, -0.75, 1.0, 0.5, -0.25, -0.25, 1.0, 0.75, -0.75, 1.0, -0.25, -0.75, 0.25, -0.75, 0.75, 0.0, 0.0, -0.5, 0.5, -1.0, -0.25, -0.25, 1.0, 0.25, 0.25, -1.0, 0.25, -0.25, 0.0, -0.25, 0.75, -0.75, -1.0, 0.25, 0.5, 1.0, -0.25, 0.0, -0.25, -0.75, -0.75, 0.5, 0.25, 0.75, 0.5, -1.0, -0.5, -0.75, 0.25, 0.75, -0.5, 0.5, 1.0, -0.75, 0.5, 0.75, -1.0, 0.25, -0.5, 1.0, -0.5, 1.0, 0.75, -1.0, -0.5, 0.0, -0.75, -0.5, 1.0, 0.5, -1.0, 0.0, -1.0, 0.25, 1.0, 1.0, 0.0, 0.5, -1.0, 1.0, 0.5, ]);
    ...
    device30.destroy();
    render_pass_encoder2000.setPipeline(render_pipeline207);
    ...
    render_pass_encoder2022.setBindGroup(0, bind_group204);
    ...
    render_pass_encoder2002.setVertexBuffer(0, buffer2017);
    ...
    render_pass_encoder2002.setIndexBuffer(buffer203, "uint16");
    ...
    render_pass_encoder2002.end();
    render_pass_encoder2020.setVertexBuffer(0, buffer2017);
    ...
    render_pass_encoder2022.setIndexBuffer(buffer2018, "uint16");
    render_pass_encoder2021.popDebugGroup();
    render_pass_encoder2002.setIndexBuffer(buffer2011, "uint16");
    render_pass_encoder2021.endOcclusionQuery()
    render_pass_encoder2020.popDebugGroup();
    render_pass_encoder2022.drawIndirect(buffer207, 0);
    render_pass_encoder2001.setIndexBuffer(buffer2018, "uint16");
    render_pass_encoder2021.setVertexBuffer(0, buffer2019);
    ...
    render_pass_encoder2002.setIndexBuffer(buffer2018, "uint16");
    render_pass_encoder2001.popDebugGroup();

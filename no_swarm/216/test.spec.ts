...
async function main(gpu: GPU) {
    ...
    const array2 = new Float32Array([0.5, 0.5, 0.75, 1.0, -0.25, -0.75, -1.0, -1.0, -0.75, -0.5, 0.25, 0.5, 1.0, 0.0, -0.25, 0.25, 1.0, 1.0, 0.75, 0.5, -1.0, 0.5, 0.0, -0.5, 0.5, 1.0, 0.0, 0.0, 0.0, -0.5, 0.0, 0.25, -0.5, -1.0, 0.25, -0.5, 0.75, -0.25, 0.25, -0.75, -0.25, 0.75, 0.75, 1.0, -0.75, 1.0, 0.5, -0.75, -0.25, -0.75, 1.0, -0.25, 0.5, -0.25, 0.25, -0.75, -0.5, 0.75, 0.75, 0.25, 0.0, -1.0, -0.25, 0.25, 0.0, -1.0, -0.25, -0.75, -0.5, -0.75, -1.0, -0.25, 0.25, 0.5, -0.75, 0.0, 1.0, 0.5, 0.75, -0.25, -0.25, -0.25, -0.5, -0.5, 0.75, 1.0, 0.5, 0.75, -0.75, 0.75, 0.5, 1.0, 0.5, -0.5, 0.5, -0.5, -0.25, 1.0, -0.5, 0.0, ]);
    query101.destroy()
    ...
    const array3 = new Float32Array([1.0, -0.25, 0.0, 0.5, 0.5, -0.25, -0.25, -1.0, -1.0, -1.0, 0.5, -0.25, 0.5, 0.25, -0.25, 0.5, 1.0, 0.5, -0.5, -0.5, -0.75, 0.75, -0.75, 1.0, -0.25, -0.25, 0.5, -1.0, -1.0, -0.75, -0.5, -0.75, -0.25, 0.25, 0.75, -0.75, -0.5, 0.0, -0.25, 0.25, 0.25, 0.5, 0.25, -1.0, 1.0, 0.25, -0.25, 0.0, 0.25, -0.75, -0.75, 0.75, 0.5, 0.25, -0.25, -1.0, 0.0, -0.25, -0.25, -0.5, -0.5, 0.5, -0.75, 0.5, -1.0, -0.25, 1.0, 0.75, 1.0, 0.5, 0.0, -0.5, -1.0, -0.75, -1.0, -0.25, -0.75, -0.5, 0.0, -0.25, 0.25, 0.0, -0.25, -0.5, -0.5, 0.0, 1.0, -1.0, 0.0, 0.5, -1.0, -0.25, 0.75, -1.0, -0.75, -1.0, -1.0, 1.0, -0.5, 0.5, ]);
    ...
    compute_pass_encoder6030.setPipeline(compute_pipeline6015);
    ...
    device60.queue.writeBuffer(buffer603, 0, uint32_6030, 0, uint32_6030.length);

    compute_pass_encoder6030.dispatchWorkgroupsIndirect(buffer603, 0);

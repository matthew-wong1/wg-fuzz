...
async function main(gpu: GPU) {
    const array0 = new Float32Array([0.75, -1.0, -0.75, -0.75, 1.0, -0.5, 0.5, -0.25, -1.0, 0.25, 0.0, -0.5, 0.5, 0.0, 0.5, 0.75, 0.5, 0.75, 0.0, -1.0, 0.25, -1.0, -1.0, 0.75, 0.25, 1.0, -0.25, 0.5, -0.25, 0.5, -0.5, 1.0, 1.0, -0.5, 0.0, -1.0, 1.0, -0.25, 0.25, -0.5, 0.0, -0.25, 0.25, -0.5, 0.5, 0.25, -0.25, 0.5, 0.75, -0.25, 0.5, -0.25, -0.75, -0.5, -0.5, -0.5, 0.5, 0.5, -0.25, 0.5, -0.5, 0.5, -0.5, 0.75, -0.5, -0.25, -0.25, -0.25, 0.75, 0.75, 0.0, -0.75, -0.75, -1.0, 0.0, 0.75, 1.0, -0.25, 0.25, -1.0, 1.0, 0.25, -1.0, -0.25, -0.75, 0.75, -0.5, -1.0, 0.75, -1.0, -0.5, 0.25, 0.75, 0.0, -0.75, 0.5, -0.75, 0.25, -0.25, -0.75, ]);
    ...
    const array3 = new Float32Array([0.5, 1.0, -0.5, 0.5, 0.0, -0.5, -1.0, 0.0, -0.25, -0.75, 0.75, 0.25, 0.5, 0.75, -0.75, -0.25, 0.25, 0.5, -0.25, 0.0, 1.0, -0.5, 1.0, -0.5, 0.25, 0.75, 0.75, 0.75, 1.0, 0.75, -0.75, -0.5, 0.75, 0.25, -0.75, 0.25, 0.5, 0.0, 0.25, -0.75, -0.75, 0.75, 0.25, 0.5, 1.0, 1.0, 0.5, 0.5, -1.0, 1.0, -0.25, 0.0, -0.25, 0.5, 0.25, 0.5, -1.0, 0.75, -0.75, -0.75, -0.75, -0.5, 0.75, -0.25, 0.25, -0.75, 1.0, -0.5, 1.0, 0.5, 0.75, -1.0, 0.5, 0.5, -0.75, 0.5, -0.5, 0.5, -0.25, 1.0, -0.75, 1.0, 0.75, -0.5, -0.75, -0.5, 0.5, -0.75, 0.25, 0.0, -0.75, 0.5, -0.25, -1.0, 0.5, 0.25, 0.0, 0.25, 0.0, 0.5, ]);
    compute_pass_encoder0000.pushDebugGroup("group_marker")
    ...
    command_encoder005.clearBuffer(buffer0011);
    ...
    compute_pass_encoder0041.setPipeline(compute_pipeline0034);
    compute_pass_encoder0000.insertDebugMarker("marker")
    ...
    device00.queue.writeBuffer(buffer0011, 0, array3, 0, array3.length);
    command_encoder006.clearBuffer(buffer0014);
    ...
    render_pass_encoder0071.setPipeline(render_pipeline005);
    ...
    compute_pass_encoder0041.setBindGroup(0, bind_group0010);
    ...
    render_pass_encoder0071.setBindGroup(0, bind_group0012);
    render_pass_encoder0071.setVertexBuffer(0, buffer0010);
    compute_pass_encoder0030.popDebugGroup()
    ...
    render_pass_encoder0071.setIndexBuffer(buffer000, "uint16");
    compute_pass_encoder0040.popDebugGroup()
    render_pass_encoder0011.setVertexBuffer(0, buffer0023);
    ...
    render_pass_encoder0000.end();
    render_pass_encoder0071.drawIndexedIndirect(buffer0038, 0);
    render_pass_encoder0000.end();
    ...
    compute_pass_encoder0041.setBindGroup(0, bind_group0016);
    ...
    compute_pass_encoder0041.setBindGroup(0, bind_group0017);
    ...
    render_pass_encoder0071.drawIndirect(buffer006, 0);
    render_pass_encoder0071.drawIndexedIndirect(buffer0011, 0);
    compute_pass_encoder0030.end();
    ...
    render_pass_encoder0071.drawIndirect(buffer001, 0);
    compute_pass_encoder0030.popDebugGroup()
    render_pass_encoder0071.end();

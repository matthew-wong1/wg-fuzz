...
async function main(gpu: GPU) {
    ...
    const array1 = new Float32Array([0.25, 0.5, 0.25, -0.5, -0.25, 0.5, 0.75, -0.75, -0.5, 0.0, 0.75, -0.75, -1.0, 1.0, -0.25, 1.0, 0.5, -0.25, 0.25, 0.75, 0.0, -0.5, 0.0, -0.75, 0.0, -0.5, -1.0, -0.75, -0.75, -0.5, 0.0, -0.25, -1.0, 0.0, 0.5, 1.0, -1.0, 0.75, -0.5, -0.5, -0.5, 0.5, -1.0, 0.25, -0.5, 1.0, -0.5, 1.0, -0.75, -0.25, -0.75, -0.5, 0.0, 0.0, 0.25, 0.0, -0.5, 0.0, -1.0, 1.0, 0.5, -1.0, 0.25, -0.5, -0.25, 0.75, 1.0, -0.25, 0.75, -1.0, -0.25, -0.25, -1.0, -0.25, 1.0, 0.75, 0.75, 0.75, 0.75, -0.5, -0.5, 1.0, -0.5, 1.0, 0.0, 0.75, -1.0, 0.5, 0.0, -0.25, 0.25, -0.75, 0.0, 0.25, 1.0, -0.25, -0.75, 0.0, -0.5, 1.0, ]);
    ...
    device00.queue.writeBuffer(buffer004, 0, uint32_0050, 0, uint32_0050.length);

    compute_pass_encoder0050.dispatchWorkgroupsIndirect(buffer004, 0);
    ...
    compute_pass_encoder0051.setPipeline(compute_pipeline0018);
    
    compute_pass_encoder0051.insertDebugMarker("marker")
    compute_pass_encoder0051.pushDebugGroup("group_marker")
    compute_pass_encoder0040.pushDebugGroup("group_marker")
    ...
    compute_pass_encoder0031.setPipeline(compute_pipeline0022);
    ...
    compute_pass_encoder0051.setBindGroup(0, bind_group006);

...
async function main(gpu: GPU) {
    ...
    device10.destroy();
    const array2 = new Float32Array([0.0, 0.5, -1.0, -0.5, 0.0, 0.0, -1.0, -0.5, 0.0, 1.0, 1.0, -0.25, -0.25, -0.5, 1.0, 0.25, -0.5, 0.25, 0.75, -0.25, -0.75, 0.25, 0.0, -0.75, -0.75, -0.75, -0.5, -0.25, -0.5, -0.5, -0.25, 1.0, 0.5, -0.75, 0.25, -0.5, 0.75, -0.5, -0.5, -1.0, 1.0, 0.0, -0.75, -0.25, -0.5, 0.75, -1.0, 1.0, -1.0, 0.75, 0.25, -0.5, 1.0, 0.25, 0.5, 0.75, 0.5, -0.25, 0.75, -0.25, 0.0, 0.0, 0.75, -1.0, 0.25, 1.0, -0.5, -0.25, 0.5, -0.75, 0.5, 1.0, 0.5, -0.5, 0.25, 0.25, 1.0, -0.75, 0.0, 0.0, -0.5, -0.25, 0.0, 0.25, -0.25, 1.0, -0.75, -0.25, 0.75, -0.25, -1.0, 0.0, 0.75, -0.25, 0.25, -1.0, 0.0, -0.25, -0.75, 0.5, ]);
    ...
    render_bundle_encoder301.setIndexBuffer(buffer302, "uint16");
    ...
    render_bundle_encoder301.drawIndexedIndirect(buffer302, 0);
    ...
    render_pass_encoder0010.executeBundles([render_bundle_encoder000, render_bundle_encoder002, ])
    ...
    render_bundle_encoder302.drawIndexedIndirect(buffer300, 0);

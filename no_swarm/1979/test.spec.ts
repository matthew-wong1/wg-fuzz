...
async function main(gpu: GPU) {
    ...
    texture002.destroy();
    const array0 = new Float32Array([-0.5, -1.0, 1.0, 0.25, 0.0, 1.0, -1.0, 0.5, 1.0, -0.5, -0.75, -0.75, -0.75, -0.25, -0.75, -1.0, 0.75, -0.25, 0.0, -0.75, 0.75, -0.5, 1.0, 0.5, 0.75, -1.0, -0.75, -1.0, -0.75, 1.0, 1.0, 0.0, 0.5, -0.75, -1.0, 0.5, 0.0, -1.0, 0.5, 0.0, -0.5, -0.5, -0.25, 0.5, 1.0, -0.5, 0.25, -1.0, -1.0, 1.0, -0.25, -0.25, 0.75, 0.75, 0.5, -0.5, 0.25, -0.75, -1.0, -0.5, -0.75, -0.25, 0.0, 1.0, 1.0, -1.0, 0.25, -1.0, 0.0, 1.0, -0.5, 0.75, 0.75, -1.0, 0.25, -0.25, 0.5, 1.0, 0.5, 0.25, 0.25, -0.25, 0.5, 0.75, 0.25, 0.75, -1.0, 0.75, 0.25, -0.25, 0.75, 0.75, 0.25, -0.75, -1.0, 0.5, 0.75, -0.25, -0.25, -1.0, ]);
    ...
    const array3 = new Float32Array([-0.75, -0.25, -0.5, -1.0, -0.75, 0.0, 0.75, 0.25, 0.0, 0.25, 0.25, -0.5, 0.0, 0.25, 0.75, 0.0, 0.5, 1.0, -1.0, 0.5, 0.25, 1.0, -1.0, -0.5, 0.25, 1.0, 0.5, -0.5, -0.5, 0.5, 1.0, -1.0, -1.0, 0.5, -1.0, 0.0, -0.25, 0.75, 1.0, 0.25, 0.0, -1.0, 0.0, -0.5, -0.5, 0.0, 0.25, -1.0, -1.0, 0.75, -0.75, -1.0, 1.0, 1.0, 0.5, 0.5, -0.5, -1.0, 0.0, 0.75, -0.25, 1.0, -0.75, -0.5, -1.0, -0.25, -0.75, 0.75, 0.5, -0.5, -0.25, -0.25, 0.5, -0.75, 1.0, 0.0, -0.5, -1.0, 0.0, 0.75, 1.0, 0.5, 0.5, 0.25, 0.0, 0.0, 0.0, 0.25, -0.5, 1.0, -0.5, 1.0, 0.25, 0.75, -0.25, 0.5, 0.75, 1.0, -1.0, -0.25, ]);
    ...
    device20.queue.writeBuffer(buffer2022, 0, uint32_2040, 0, uint32_2040.length);

    compute_pass_encoder2040.dispatchWorkgroupsIndirect(buffer2022, 0);
}
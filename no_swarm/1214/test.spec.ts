...
async function main(gpu: GPU) {
    ...
    texture300.destroy();
    const array1 = new Float32Array([-0.25, 0.25, -1.0, 0.25, -0.25, 0.5, -1.0, 1.0, 0.5, -0.75, -1.0, 0.75, -0.5, 0.25, -0.5, 0.0, 0.0, -0.75, -1.0, -0.5, -0.25, 0.5, -0.75, 0.25, -0.25, 0.5, -0.5, 1.0, 0.75, -0.75, -1.0, 0.75, 0.75, -0.25, 1.0, -0.75, 0.0, 0.25, -0.25, 0.5, 1.0, -0.5, -0.25, 0.5, -0.75, -0.5, -0.25, -0.5, 1.0, -0.25, -0.25, -0.5, 0.0, 0.75, 0.75, -0.25, -0.5, 0.25, 0.5, -1.0, -0.75, 0.75, 0.25, -0.25, 1.0, 0.5, 0.75, 0.25, -0.5, 0.25, -0.75, -0.5, -0.5, 1.0, -1.0, 1.0, 1.0, -0.25, 0.0, -1.0, 0.0, -1.0, 1.0, 0.75, 0.25, 1.0, 0.5, 0.75, 0.75, 0.25, -0.25, -0.25, -0.25, 0.75, 0.25, 0.0, 0.75, 0.75, -0.5, -1.0, ]);
    ...
    compute_pass_encoder3020.setPipeline(compute_pipeline3049);
    ...
    compute_pass_encoder3021.setPipeline(compute_pipeline308);
    ...
    const bind_group303 = device30.createBindGroup({
        label: "bind_group303",
        layout: compute_pipeline3049.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {
    ...
    const compute_pass_encoder3022 = command_encoder302.beginComputePass({ label: "compute_pass_encoder3022" });
    
    
    render_bundle_encoder300.insertDebugMarker("marker");
    compute_pass_encoder3022.setPipeline(compute_pipeline3066);
    ...
    compute_pass_encoder3021.setBindGroup(0, bind_group304);
    ...
    device30.queue.writeBuffer(buffer3017, 0, uint32_3021, 0, uint32_3021.length);

    compute_pass_encoder3021.dispatchWorkgroupsIndirect(buffer3017, 0);
    ...
    const bind_group305 = device30.createBindGroup({
        label: "bind_group305",
        layout: compute_pipeline3066.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {
    ...
    compute_pass_encoder3022.setBindGroup(0, bind_group305);
    compute_pass_encoder3022.dispatchWorkgroups(100);
    compute_pass_encoder3021.dispatchWorkgroups(100);
    compute_pass_encoder3022.end();
    compute_pass_encoder3021.end();
    ...
    compute_pass_encoder3022.setBindGroup(0, bind_group306);
    ...
    compute_pass_encoder3021.setBindGroup(0, bind_group307);

...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([1.0, -0.25, 0.0, -1.0, -0.5, 1.0, -1.0, 0.25, -0.75, 0.75, 0.0, 0.75, 0.25, 1.0, -0.75, 0.25, -0.75, 0.75, 1.0, 0.0, -0.5, 0.25, 0.75, -0.25, -0.75, -0.5, -0.25, 0.75, 0.75, 0.0, -0.25, 0.25, 0.0, -1.0, 0.5, -0.75, 0.5, -0.75, -0.5, 0.5, 0.0, -0.75, -0.75, 0.75, -0.25, -0.5, -0.5, 0.75, -0.75, 0.75, -1.0, 0.0, -0.5, 0.25, -0.75, 0.25, 0.75, 0.25, -1.0, 1.0, -1.0, -0.75, -0.5, -0.25, -0.25, 0.25, 0.25, 0.0, 1.0, 0.75, -0.75, 0.75, 0.5, -0.5, 0.5, 0.25, 1.0, 0.25, 0.5, 0.5, -0.5, -0.75, 1.0, -0.75, -1.0, 0.0, 0.5, 0.5, -1.0, 0.75, 1.0, -0.75, 1.0, -0.5, 1.0, -0.75, -1.0, -0.75, -0.25, 0.25, ]);
    ...
    device00.queue.writeBuffer(buffer0015, 0, uint32_0001, 0, uint32_0001.length);

    compute_pass_encoder0001.dispatchWorkgroupsIndirect(buffer0015, 0);
    ...
    buffer007.destroy()
    const array1 = new Float32Array([-1.0, -0.25, -0.5, 0.0, 0.25, -0.5, 1.0, -0.5, -0.25, -0.25, 0.75, 0.5, 0.5, 0.0, -1.0, -0.75, -0.5, 0.75, -0.75, -0.75, 0.0, -0.25, 0.75, 0.75, -1.0, 0.5, 0.0, -0.25, -0.25, 0.0, -1.0, -0.5, 0.25, 0.0, -0.5, 1.0, 0.25, -0.75, 0.5, 0.0, 0.75, -0.5, -1.0, -0.75, 0.5, 0.75, -0.25, 0.0, 0.25, 0.5, -0.75, 0.25, -1.0, -0.25, 0.0, -0.5, -1.0, -1.0, 0.25, -1.0, -1.0, 1.0, -1.0, 0.25, 0.75, 0.5, 0.25, 0.5, -0.75, 1.0, 0.5, 0.5, 0.0, 0.0, -0.75, 1.0, -0.25, 0.0, -0.5, -0.75, -0.75, -0.25, -1.0, 0.0, -1.0, 0.75, -0.75, 0.25, -0.5, -0.25, 0.25, 0.25, -0.75, -0.75, -0.25, 0.75, -1.0, 0.75, 0.75, 0.0, ]);
    ...
    render_bundle_encoder000.drawIndexedIndirect(buffer0015, 0);

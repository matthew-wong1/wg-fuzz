...
async function main(gpu: GPU) {
    ...
    command_encoder106.clearBuffer(buffer103);
    query100.destroy()
    const array1 = new Float32Array([0.25, -0.5, 0.5, -1.0, -0.5, 0.0, -0.25, -0.25, 0.5, 1.0, 0.5, -0.75, -1.0, 0.25, -1.0, 0.5, -0.25, 0.0, 0.0, -0.5, -0.25, 1.0, 0.5, -1.0, 0.0, -0.25, 1.0, -0.5, -1.0, 0.75, 0.5, 0.0, -1.0, 0.25, -0.75, 0.5, -0.25, -0.75, -0.75, 0.5, -1.0, 0.5, 0.0, 0.0, -1.0, -0.25, -0.75, -0.25, -0.75, 1.0, -0.75, 1.0, -0.75, 0.75, -0.25, -0.5, 1.0, -0.25, 0.75, -1.0, -0.25, 1.0, -0.75, 0.5, -0.75, 0.75, 0.75, -0.75, -0.75, 0.75, 0.75, 0.75, 1.0, 1.0, -1.0, -0.75, 0.5, -0.25, -0.5, -0.25, 0.0, 0.5, -0.25, -0.25, -1.0, 1.0, -0.75, 0.25, 0.25, -0.25, -0.5, 0.25, 0.5, -0.75, 0.75, 0.5, -0.25, -1.0, -0.25, 1.0, ]);
    ...
    const array2 = new Float32Array([-1.0, 0.75, -0.25, -0.75, 0.25, -0.25, 1.0, -0.25, -0.5, 0.75, -0.5, 0.5, 0.75, 1.0, 1.0, -0.5, -0.25, 0.0, -0.5, -0.5, -0.5, 0.0, 0.25, 1.0, -0.75, 0.25, 0.5, -0.25, -0.25, -0.5, -1.0, 0.25, 0.25, 1.0, 0.25, -1.0, -0.25, 0.0, 0.0, 0.5, 0.75, 0.25, 0.75, 0.75, 0.5, -0.75, -1.0, -0.25, -1.0, 1.0, -1.0, 0.25, 0.5, -1.0, 0.0, 0.25, 0.0, -1.0, 0.25, -0.25, -0.25, 0.25, -0.75, 0.75, 1.0, 0.75, 1.0, 0.0, 0.25, 0.5, -0.75, 1.0, 0.25, 0.75, 1.0, -0.75, -0.25, -0.5, 1.0, -0.75, 1.0, 0.75, 0.5, -0.25, -0.25, -0.75, 1.0, -1.0, 0.25, 0.0, 1.0, 0.25, -0.5, -0.75, 0.25, 0.5, 0.75, 0.0, -0.25, 0.0, ]);
    render_bundle_encoder102.insertDebugMarker("marker");
    render_bundle_encoder101.insertDebugMarker("marker");
    texture200.destroy();

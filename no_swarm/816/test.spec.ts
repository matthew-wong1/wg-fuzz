...
async function main(gpu: GPU) {
    ...
    render_bundle_encoder200.insertDebugMarker("marker");
    const array0 = new Float32Array([-0.25, -0.25, -1.0, 0.25, 1.0, -0.25, 0.25, 0.25, 0.75, -0.25, 1.0, -0.75, -0.25, -0.5, -0.25, 0.25, -0.25, -1.0, -1.0, -0.25, -0.5, -0.75, 0.0, 0.75, 0.75, -1.0, -1.0, -0.25, -0.75, 0.5, 0.0, -1.0, 0.0, -0.25, -1.0, -0.25, 1.0, 0.5, 1.0, 0.0, 0.5, -0.75, -0.75, 0.25, 0.75, 1.0, 0.25, 1.0, -0.75, 0.75, -0.75, 0.75, -1.0, -0.5, -1.0, -0.5, 0.25, 0.5, -1.0, -0.5, 0.75, 0.25, -0.25, -0.5, -0.5, -0.25, 0.75, -0.25, -0.5, 0.5, 0.75, -0.5, -0.5, 0.5, 0.0, -0.25, -0.5, 0.0, -0.5, -0.75, -0.75, -0.25, 1.0, 1.0, 0.25, 0.0, 0.25, -0.75, -0.25, 1.0, -0.75, -0.25, -0.75, -0.75, -0.25, -1.0, -1.0, 0.5, -1.0, -0.5, ]);
    buffer204.destroy()
    ...
    const array2 = new Float32Array([-0.75, 0.25, 0.0, -0.75, 0.75, 0.0, 0.5, -0.75, -0.25, 0.0, 0.0, -0.5, 0.25, 0.5, 0.0, -1.0, 0.25, 0.5, -1.0, -0.5, 1.0, 0.75, 0.75, -0.5, -0.25, 0.25, -0.5, -0.25, 1.0, -1.0, 0.5, 0.25, 0.0, 1.0, -1.0, -1.0, -1.0, -0.75, 0.75, -0.25, 0.75, 0.5, -0.25, 0.75, -0.5, 1.0, 0.5, -1.0, 0.0, 0.5, 0.75, -1.0, -0.5, 0.25, -0.25, 0.0, -0.25, -0.5, -1.0, 0.25, -0.75, 1.0, 0.75, -1.0, 0.0, 0.25, 0.5, -0.25, 0.75, 1.0, 0.75, -1.0, 0.75, 0.5, -0.75, 1.0, -0.5, -0.25, 0.5, 0.5, 0.0, 0.5, 1.0, -0.5, -0.25, 0.75, 1.0, -0.75, -0.5, -0.5, -0.25, -0.25, -0.5, 0.75, 1.0, -0.5, 0.0, 0.25, -0.25, -1.0, ]);
    ...
    const array4 = new Float32Array([0.0, -0.25, -0.75, -0.5, -1.0, 0.75, 0.25, 0.5, -0.5, -0.5, 0.5, 0.75, -0.75, -0.75, -1.0, -0.25, 0.75, 1.0, 0.25, 0.5, -0.5, 0.0, 0.5, 1.0, 0.25, 0.0, 0.75, -0.25, 0.0, -1.0, -0.75, 0.75, 1.0, -0.5, -0.25, -0.75, -0.75, -0.25, 1.0, -0.25, 1.0, 0.0, 0.5, 0.0, 0.25, -0.75, 0.25, -0.5, 0.5, 1.0, 0.25, 1.0, -0.25, 0.75, 0.5, 1.0, -0.75, 0.75, -0.75, 1.0, 0.5, 1.0, 0.5, 1.0, 1.0, -0.25, 0.5, 0.25, -0.5, 0.25, 0.25, 0.25, 0.5, -0.5, 0.25, 0.0, 0.25, -1.0, 1.0, 0.5, 0.75, 0.5, 0.25, 0.75, -0.75, 0.25, 1.0, 0.5, 0.75, -0.5, 0.0, 0.0, -0.5, 0.75, -1.0, 0.25, -0.75, -0.25, -0.25, -0.75, ]);
    render_pass_encoder2030.setStencilReference(1);
    render_pass_encoder2040.setBlendConstant([1.0, 0.0, 0.0, 1.0]);
    ...
    const array5 = new Float32Array([-0.75, -0.5, -0.25, 0.0, -0.75, 0.25, -0.75, 0.0, 0.75, -0.25, 0.75, -1.0, 0.5, 0.25, -1.0, 0.25, 0.75, -0.5, 0.0, 1.0, -0.75, 0.75, 0.5, 0.25, 0.75, -0.75, 1.0, 0.75, 0.25, 0.0, 0.0, -1.0, -0.5, 0.0, 0.5, 0.75, -1.0, 1.0, -0.75, 1.0, 0.0, 0.25, 0.0, -0.5, 1.0, 0.25, -0.25, 0.25, -0.5, 0.75, 0.0, 1.0, -1.0, -1.0, -0.75, 0.5, 0.25, 0.0, -0.5, 0.0, 0.5, -1.0, 0.0, -0.25, -0.25, -1.0, -1.0, -0.25, -0.5, 0.5, -0.5, -1.0, 0.25, -0.25, -0.25, -1.0, 1.0, -0.25, -1.0, 0.75, -1.0, 0.5, 0.25, 0.75, 1.0, 0.5, -1.0, 1.0, -0.75, 1.0, 0.5, -0.75, -1.0, 0.75, 0.5, 0.75, 0.5, 1.0, 0.25, -0.75, ]);
    ...
    render_bundle_encoder202.setVertexBuffer(0, buffer2016);
    ...
    buffer2019.destroy()
    render_pass_encoder2040.setVertexBuffer(0, buffer2016);
    ...
    render_pass_encoder2031.setPipeline(render_pipeline2019);
    ...
    render_pass_encoder2050.setPipeline(render_pipeline2026);
    device30.popErrorScope().then((error) => {
        if (error) {
            console.error(`An error occurred: ${error.message}`);
        }
    ...
    const bind_group207 = device20.createBindGroup({
        label: "bind_group207",
        layout: render_pipeline2026.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {

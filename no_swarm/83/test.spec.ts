...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-0.25, -0.75, -0.5, -0.75, -0.75, 1.0, 0.5, 0.0, -0.5, -1.0, -0.5, -1.0, -0.75, 0.25, 1.0, -0.5, 1.0, -0.75, 0.25, -0.25, 0.0, -1.0, -0.5, -0.75, -0.5, 0.25, 0.5, 1.0, -0.75, 1.0, -0.5, 0.75, 1.0, -0.25, 0.75, 0.75, -0.25, -1.0, -1.0, -0.5, 0.25, -1.0, 0.5, 0.5, 0.0, -0.5, 0.25, 0.75, 0.25, -1.0, -0.25, 0.25, -1.0, 0.5, 0.5, -0.5, 0.75, 0.0, -1.0, -1.0, -0.5, -0.75, 0.5, -0.5, -0.25, -0.75, -0.5, 0.75, 0.5, 0.25, -1.0, 1.0, -1.0, -0.5, -0.25, 0.25, -0.75, -1.0, -0.25, -0.25, 0.0, 0.75, -1.0, 1.0, 0.25, 0.75, -0.5, 0.75, 0.0, -1.0, -0.5, 1.0, 0.25, -0.5, -0.25, 1.0, 0.5, 1.0, 0.5, -0.25, ]);
    ...
    const array1 = new Float32Array([-0.25, -0.5, 1.0, 0.75, -0.75, 0.5, -0.25, 0.5, -0.25, -0.25, 0.25, 0.25, -0.5, -0.75, 1.0, 0.0, 0.5, -0.75, 0.25, -1.0, 0.0, 1.0, -0.25, 1.0, 0.0, 0.25, 0.0, -0.75, -0.25, -0.75, -0.5, -0.25, 1.0, 1.0, -0.25, -0.75, -0.25, -0.5, 0.75, 0.5, -1.0, -1.0, 0.5, 0.25, 0.25, 0.5, 0.25, 0.0, 0.75, 0.25, 1.0, 0.25, 0.75, -0.25, -1.0, 0.75, 0.5, 0.75, 0.25, 0.5, 1.0, 0.0, -0.5, -1.0, 0.25, 0.5, 0.75, 0.5, 0.25, 1.0, 0.5, -0.5, -1.0, -0.5, 0.5, 0.25, 1.0, -0.75, -0.5, 0.5, 0.75, 0.25, 0.25, 0.75, 1.0, -0.5, 0.75, -0.75, -1.0, -1.0, -0.75, 0.25, -0.75, 1.0, 0.75, -0.25, 0.25, 1.0, 0.5, 1.0, ]);
    ...
    const array3 = new Float32Array([0.5, 0.75, -0.75, 1.0, 1.0, 0.5, 1.0, 0.0, -0.5, -1.0, 0.75, -0.25, 0.25, 0.75, 0.0, 0.25, -0.5, 1.0, -0.5, -0.75, 0.5, 0.5, 0.0, -0.25, 0.25, 0.25, 0.25, -0.25, -1.0, -0.75, 0.5, 0.0, -1.0, -0.25, 1.0, 0.25, 0.0, -0.5, 0.5, 1.0, 0.25, -1.0, -1.0, 0.25, -0.5, -1.0, 0.0, 0.75, 0.0, -0.25, -1.0, -1.0, 0.5, -0.25, -0.75, 0.5, 0.0, -1.0, 0.5, 0.0, 0.0, -0.25, -0.5, 0.75, -0.75, -0.5, 0.25, 0.25, 0.5, 0.25, -1.0, 0.5, -0.25, -1.0, 0.75, 0.75, -1.0, -0.25, -0.25, 0.0, 1.0, 0.5, 1.0, 1.0, -0.5, 0.25, 0.75, 0.0, 0.0, -0.5, -0.5, 0.5, -0.5, -0.75, -0.25, -1.0, 0.75, -0.75, -1.0, -1.0, ]);
    ...
    query000.destroy()
    compute_pass_encoder1010.setPipeline(compute_pipeline10109);
    ...
    render_pass_encoder1020.setPipeline(render_pipeline1014);
    ...
    const bind_group102 = device10.createBindGroup({
        label: "bind_group102",
        layout: compute_pipeline10109.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {

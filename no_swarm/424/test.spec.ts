...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([0.75, -1.0, -0.75, 0.5, -0.5, 0.5, -1.0, -0.5, -0.25, 0.0, -0.5, 0.75, -0.75, 1.0, -0.25, -1.0, 0.5, -0.75, -1.0, 0.0, 0.75, 1.0, -0.25, -0.5, -0.75, 1.0, -0.75, -0.75, -1.0, 0.25, -0.25, 0.25, 0.5, -0.25, -1.0, -1.0, -1.0, 0.5, -0.5, 0.75, -0.5, -0.5, -1.0, 0.75, 0.75, 0.0, -0.25, 0.5, 0.25, 0.25, 0.25, 1.0, 0.75, -0.75, 1.0, -1.0, -0.75, 0.25, -0.75, 1.0, -0.75, 1.0, -0.5, 0.25, 0.25, -0.25, 0.5, -0.5, 0.25, 0.25, -0.5, -0.25, -1.0, -1.0, 0.5, 0.5, -1.0, 0.75, -0.75, 0.75, 0.5, -0.75, 0.0, 0.0, 0.25, -0.5, -0.75, -0.25, 1.0, 0.75, 1.0, -0.75, 0.0, -0.5, -0.5, 1.0, -1.0, 0.25, 0.75, 0.0, ]);
    ...
    const array1 = new Float32Array([0.5, 1.0, 0.75, -0.75, 0.25, 1.0, 0.75, 0.0, -1.0, -0.5, 1.0, 0.25, -0.5, 0.0, 0.0, 0.0, 1.0, -0.5, -0.75, -1.0, 1.0, 1.0, -1.0, -0.75, 1.0, 0.75, -0.5, -0.25, 0.0, 0.25, -1.0, 0.0, 0.5, 0.5, 1.0, -0.75, 0.25, 0.5, 1.0, -0.25, 1.0, 0.5, -1.0, 0.5, 0.0, -0.75, -0.5, -0.5, -0.25, 0.25, 0.0, 0.5, -1.0, 0.5, -0.75, 0.25, 1.0, -1.0, -1.0, -0.25, 0.25, 0.0, 0.5, 0.5, 0.0, 0.75, 1.0, -0.75, -0.75, -0.5, -1.0, 1.0, 0.0, 0.25, 1.0, -0.25, -1.0, 0.5, 0.75, 0.5, 0.25, 0.0, 0.25, -0.25, 0.0, 0.0, 0.0, -0.25, 0.5, 0.5, 0.25, -0.25, 0.25, 0.5, 0.0, 0.5, -0.5, 0.25, -0.5, 0.5, ]);
    ...
    device40.queue.writeBuffer(buffer4010, 0, uint32_4040, 0, uint32_4040.length);

    compute_pass_encoder4040.dispatchWorkgroupsIndirect(buffer4010, 0);

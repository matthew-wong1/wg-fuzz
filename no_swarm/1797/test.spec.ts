...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([0.25, -0.75, -0.5, 0.75, -0.75, 0.75, 0.0, -0.75, 1.0, -0.5, 0.0, -0.5, -0.25, 0.5, -0.75, -0.5, 0.25, 0.25, 0.5, 0.25, 0.5, 0.5, -0.5, 1.0, 0.25, -0.5, -1.0, 0.25, -0.25, -1.0, 0.5, -0.5, 0.5, -0.25, -0.25, -0.5, -1.0, -0.5, -0.25, -0.5, -0.75, 0.5, 0.25, 0.5, 1.0, 0.75, 0.75, 0.5, 0.75, 0.5, 0.25, 0.75, -0.5, 1.0, -0.5, 0.75, -0.5, 0.5, 0.25, 0.75, -0.5, 0.25, -0.5, 0.0, -0.5, 0.0, 0.75, 0.0, -0.5, 0.0, 0.5, -0.5, 0.5, 0.5, -0.25, 0.75, 0.25, 0.25, 0.25, 0.75, -0.75, -0.25, 0.5, 0.5, -0.25, 1.0, 0.25, -0.25, -0.75, -0.25, -0.75, 0.0, -0.5, -0.5, -0.75, -0.75, -0.75, 0.75, 0.75, -0.25, ]);
    ...
    const array4 = new Float32Array([0.0, -1.0, 0.5, -0.5, -0.25, 0.25, 0.75, -0.75, -1.0, -1.0, 0.0, -0.5, -0.25, -0.5, 0.5, -0.25, 0.0, 0.75, 1.0, 1.0, 1.0, 0.5, 1.0, -0.75, -0.75, 0.5, 0.75, 0.5, -0.5, 1.0, 0.0, 1.0, -0.75, 0.5, 0.0, -1.0, -0.5, 0.75, -1.0, 0.25, 0.75, 1.0, -1.0, 1.0, 0.25, 0.0, -0.75, 0.0, 1.0, 0.0, 0.0, 0.5, -0.25, -1.0, -1.0, 1.0, -1.0, 0.5, 1.0, -0.5, -0.5, -0.75, -1.0, -0.25, -0.5, 0.75, 0.5, -0.25, -0.5, 1.0, 0.5, 0.75, 0.0, -0.5, 0.0, -0.5, -1.0, 0.0, -0.25, -0.25, 0.0, 0.25, -0.75, -0.25, -0.5, 0.0, -0.75, 1.0, -1.0, 0.75, -1.0, -0.25, -0.75, -0.75, -0.5, 1.0, -0.75, 1.0, 0.0, 0.75, ]);
    device00.popErrorScope().then((error) => {
        if (error) {
            console.error(`An error occurred: ${error.message}`);
        }
    ...
    const array5 = new Float32Array([-0.5, -1.0, -1.0, -0.5, 0.75, 0.75, 0.75, 0.0, -1.0, 0.0, 0.0, -1.0, -0.5, -0.25, 0.0, 0.25, -0.5, 0.5, 0.5, -0.25, -0.25, -0.5, 0.5, -0.5, -1.0, 0.25, -0.5, 0.5, -0.5, 0.5, -0.75, 0.0, 0.25, 1.0, -0.25, -0.5, 1.0, -0.5, 0.5, 1.0, -0.75, 1.0, 0.75, -1.0, -0.5, -0.5, 0.25, 1.0, 0.75, -1.0, 0.25, 1.0, 0.5, 0.0, -0.25, 1.0, -0.75, 0.75, -0.5, 0.5, 0.25, 0.0, 0.25, 0.75, 0.0, 0.25, 0.0, 1.0, 0.5, 0.25, 0.5, 0.0, -1.0, -1.0, 0.25, 0.5, 0.75, 0.0, 0.75, 0.0, 0.0, 0.5, -1.0, -0.25, -0.75, 0.5, 1.0, 0.5, 0.5, 1.0, 0.75, -0.25, -0.5, 0.25, -0.75, -0.5, 1.0, 0.25, 0.0, -0.25, ]);
    buffer101.destroy()
    ...
    render_bundle_encoder004.setBindGroup(0, bind_group002);
    ...
    render_bundle_encoder004.setVertexBuffer(0, buffer006);
    command_encoder104.resolveQuerySet(
        query100,
        0,
        32,
    ...
    const array6 = new Float32Array([-0.75, 0.75, -0.25, -0.75, 0.5, -1.0, -0.25, 0.75, 1.0, 1.0, 0.25, 0.0, 0.0, 0.5, 0.25, 0.0, -0.75, 0.5, -0.5, 0.5, -1.0, 0.0, 0.75, 0.25, 1.0, 0.0, 0.5, 0.75, 0.75, -0.25, 1.0, -0.25, 0.5, 0.25, -0.25, 0.75, 0.0, 0.0, 0.75, -1.0, -1.0, -0.75, -1.0, -0.25, 0.0, 0.5, 0.25, -0.75, -1.0, -0.75, 0.75, -0.5, 0.25, 1.0, -0.25, -0.75, -0.75, 1.0, -0.75, 0.5, 1.0, 0.5, 0.0, -1.0, 0.5, -0.5, -1.0, 0.5, 1.0, -0.75, 0.0, 1.0, 0.75, 0.0, 0.25, -0.75, 0.5, 0.5, -0.75, 0.0, 0.25, -0.5, 0.5, -0.25, -0.25, 0.5, -1.0, 0.75, 0.75, 0.0, 0.5, -1.0, -0.25, 1.0, 0.0, 0.0, -0.5, 0.0, -0.5, -0.25, ]);
    ...
    compute_pass_encoder0001.setPipeline(compute_pipeline0033);
    query001.destroy()

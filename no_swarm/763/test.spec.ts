...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-0.75, 0.0, -0.5, -0.5, -0.25, 0.25, 0.5, -0.25, -0.75, -0.5, 0.25, 0.75, -0.25, 0.0, 0.5, -0.75, 1.0, 0.25, -0.75, -0.5, -1.0, -0.25, 0.5, 0.5, 0.0, 0.0, -0.5, 1.0, -0.75, -0.5, 1.0, -1.0, -0.75, 0.5, 1.0, -0.25, 0.5, 1.0, -1.0, -0.25, -0.5, -0.5, -0.5, -1.0, 0.0, 1.0, -1.0, 0.25, -0.5, -0.5, -0.5, -0.25, 0.0, 0.25, 0.25, -0.75, -1.0, -1.0, -1.0, -0.25, 0.5, 0.25, 0.25, -0.5, -0.5, -0.25, -0.25, 1.0, 0.25, 0.5, -0.75, 0.25, 1.0, -0.5, 0.5, 0.25, 0.0, -1.0, -1.0, -0.25, -0.75, 1.0, 0.75, 0.5, 0.75, -1.0, 0.25, 0.25, 0.25, 1.0, -0.5, 0.5, 0.0, 0.5, -0.5, 0.75, -0.75, -0.25, 0.5, 0.25, ]);
    ...
    device00.queue.writeBuffer(buffer005, 0, uint32_0040, 0, uint32_0040.length);

    compute_pass_encoder0040.dispatchWorkgroupsIndirect(buffer005, 0);
    ...
    const array1 = new Float32Array([0.25, -0.5, 0.25, -0.75, -0.5, 0.0, -0.5, 0.75, 1.0, 0.0, -0.75, -1.0, -0.75, -0.25, 0.75, 0.25, -0.75, -0.25, -0.25, 0.5, -1.0, -0.5, -0.75, -1.0, 0.5, 0.5, 1.0, 1.0, 0.75, -0.5, 0.75, 1.0, -1.0, -0.25, 0.0, -1.0, 1.0, -1.0, -0.5, 0.0, -1.0, 0.0, -1.0, -0.25, 1.0, 0.0, -1.0, 0.5, 0.0, -0.75, 0.75, 0.0, -1.0, 0.5, 0.5, 0.25, -0.5, -1.0, 1.0, -1.0, -0.5, -1.0, 1.0, 0.0, -0.5, 0.0, 0.75, 0.0, 1.0, 0.5, 0.0, 0.25, 0.5, -0.75, -0.5, -1.0, 0.5, -0.5, -0.75, -1.0, -0.25, 1.0, 0.75, 0.5, 0.25, 0.5, 0.0, 0.0, -1.0, 0.5, 0.25, 0.5, -0.25, 0.75, 0.0, 0.25, -0.75, 0.0, -1.0, 0.75, ]);
    ...
    compute_pass_encoder3060.setPipeline(compute_pipeline305);
    ...
    compute_pass_encoder3060.setBindGroup(0, bind_group300);
    compute_pass_encoder1000.pushDebugGroup("group_marker")
    ...
    device30.queue.writeBuffer(buffer306, 0, uint32_3060, 0, uint32_3060.length);

    compute_pass_encoder3060.dispatchWorkgroupsIndirect(buffer306, 0);

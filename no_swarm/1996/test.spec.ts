...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-0.25, 1.0, 1.0, 0.5, 0.0, -0.25, -0.75, 0.75, -0.75, 1.0, 0.75, 0.0, 0.5, 0.0, -0.75, -0.25, -0.25, -0.5, -0.5, -0.25, 0.5, -0.5, 0.5, 1.0, -0.75, -0.5, -0.25, 0.75, -0.75, -0.25, 0.25, 0.5, -1.0, 0.75, 0.5, -0.25, -0.25, 0.5, -0.5, 0.75, -0.25, 1.0, -0.25, 0.75, -0.25, 1.0, 0.75, -0.25, -0.25, 0.25, 0.25, -0.75, -0.25, -1.0, 0.75, 0.25, 0.75, -0.5, -0.75, 1.0, -1.0, -0.75, 0.5, -0.5, 1.0, -0.25, -0.75, 0.25, -0.5, -0.5, -0.75, 0.25, 0.25, 0.5, -0.25, -0.25, 1.0, 0.0, 0.0, -0.75, -0.75, -0.75, 0.5, 1.0, 0.0, 0.0, -0.75, 0.75, 0.25, 1.0, -1.0, -1.0, 0.75, -0.75, 0.75, 0.25, 0.0, -0.25, 0.5, 0.25, ]);
    ...
    render_pass_encoder0002.setScissorRect(0, 0, texture006.width / 2, texture006.height / 2);
    ...
    render_pass_encoder0011.setStencilReference(1);
    render_pass_encoder0001.insertDebugMarker("marker");
    render_bundle_encoder202.drawIndexedIndirect(buffer202, 0);
    ...
    render_bundle_encoder202.drawIndirect(buffer2014, 0);
    render_pass_encoder0021.setScissorRect(0, 0, texture006.width / 2, texture006.height / 2);
    ...
    render_pass_encoder0002.setVertexBuffer(0, buffer0017);
    ...
    render_pass_encoder0002.setIndexBuffer(buffer001, "uint16");
    ...
    render_pass_encoder0022.setBindGroup(0, bind_group009);
    ...
    render_pass_encoder0030.setVertexBuffer(0, buffer0020);
    ...
    render_pass_encoder0002.drawIndexedIndirect(buffer0014, 0);
    render_pass_encoder0022.popDebugGroup();
    ...
    render_pass_encoder0002.drawIndirect(buffer003, 0);
    render_pass_encoder0031.drawIndexedIndirect(buffer0014, 0);

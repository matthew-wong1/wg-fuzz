...
async function main(gpu: GPU) {
    ...
    texture102.destroy();
    const array0 = new Float32Array([0.75, 1.0, 0.5, -0.75, -1.0, 0.0, 0.0, -0.25, -0.5, -1.0, -0.75, 0.75, -0.25, 1.0, -0.5, 0.5, 1.0, 0.5, 0.75, -0.5, -0.25, -0.25, 0.25, 0.75, -0.5, 0.0, -0.25, 0.25, 0.0, -1.0, -0.25, 0.25, 0.25, 0.25, -0.25, -1.0, 0.0, 1.0, -0.25, -0.5, 0.25, 0.5, -1.0, 0.0, 0.0, -0.5, -0.25, 0.75, -0.25, -0.75, -0.5, -1.0, 1.0, -0.25, -1.0, 1.0, 0.75, -0.75, -0.25, 0.25, -0.5, -1.0, 0.0, -0.5, -0.75, 0.25, -0.75, 0.0, 0.0, -0.5, -0.75, -0.25, -0.25, 0.25, 0.75, 0.5, 0.0, -0.75, 0.75, -0.25, -0.25, 0.5, 0.75, -1.0, 0.75, 0.0, 1.0, 0.5, 0.5, -0.5, 0.0, -0.25, -0.5, 1.0, 0.5, -0.5, 0.0, 1.0, 0.5, -0.75, ]);
    query100.destroy()
    ...
    const array2 = new Float32Array([-0.25, 1.0, 1.0, 1.0, -0.5, -0.75, 1.0, 1.0, 0.0, -0.25, 0.5, 0.5, 1.0, 0.25, -0.25, 1.0, -1.0, 0.5, 0.5, 1.0, -0.5, 0.75, 1.0, 1.0, 1.0, -0.25, 0.25, 0.25, 0.25, -0.75, 0.5, 0.0, 0.75, 0.5, -0.75, 0.5, -0.75, 0.5, -1.0, 0.5, -0.75, -0.5, -0.25, 0.75, -0.25, -1.0, -0.75, -0.25, 0.5, -0.75, 0.5, 0.0, -0.75, 0.5, 1.0, 0.75, -0.5, -0.75, 0.75, 0.0, 0.75, -0.25, -0.5, -1.0, -1.0, -0.5, -0.25, -0.75, -0.5, 1.0, -1.0, -0.75, -0.75, 0.5, 0.5, 0.75, -0.5, 0.75, -0.25, 0.75, -1.0, -1.0, 0.75, -0.75, 0.25, 0.0, -0.25, -1.0, -1.0, -0.75, -1.0, 0.25, -0.75, -0.25, 0.0, 0.5, -0.25, -1.0, -0.25, 0.0, ]);
    ...
    const array3 = new Float32Array([0.75, 0.5, 0.75, 0.0, 0.75, 1.0, -0.5, 0.5, 1.0, -0.5, -0.25, -0.5, 1.0, -0.5, 0.5, -0.5, 0.0, -0.75, 1.0, 0.75, 1.0, 0.75, 1.0, -0.25, -1.0, 0.75, -0.25, -1.0, 0.0, -0.75, -0.5, 0.25, 0.5, -0.75, 1.0, -0.5, 0.75, 0.25, -0.75, -0.25, -0.5, -0.75, -1.0, 0.75, 1.0, -0.25, 0.0, 1.0, 1.0, 1.0, 0.0, -0.75, 0.5, 0.5, 0.75, -0.5, 0.25, -0.75, -0.5, 1.0, -0.25, 0.0, 0.25, 1.0, 0.25, 0.5, 0.0, 0.0, -0.5, -1.0, 0.5, -0.5, 0.5, 0.75, -0.5, -1.0, 0.0, -0.25, -0.75, 0.5, -0.5, 0.0, -0.25, 0.0, 0.5, -0.5, 1.0, -1.0, 1.0, -0.25, 1.0, -0.75, 0.0, 1.0, -0.75, 0.0, 0.75, 0.25, 1.0, -0.25, ]);
    ...
    compute_pass_encoder6040.setBindGroup(0, bind_group600);
    ...
    device60.queue.writeBuffer(buffer602, 0, uint32_6040, 0, uint32_6040.length);

    compute_pass_encoder6040.dispatchWorkgroupsIndirect(buffer602, 0);

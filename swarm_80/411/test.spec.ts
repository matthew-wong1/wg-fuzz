...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-1.0, -0.5, -0.25, -1.0, 1.0, 0.0, 0.75, 1.0, 0.5, 0.0, 0.0, 0.5, 0.5, 0.5, -0.5, 0.5, 0.5, 0.25, -0.5, -0.25, -0.25, -0.25, 0.5, -0.25, -0.25, 0.75, -0.5, 0.0, -1.0, 0.0, 0.25, -0.25, 1.0, -1.0, 0.5, 0.75, -0.75, -0.75, 0.75, 1.0, -0.75, -0.75, -0.5, -0.5, 0.0, -1.0, 1.0, 0.5, 0.25, 0.5, -1.0, -0.5, 1.0, 0.25, 0.75, -0.75, 1.0, 0.5, -0.75, 1.0, 0.75, -1.0, -1.0, -0.5, 0.25, -0.25, 0.5, 0.5, -0.5, -0.5, 0.75, 0.25, -0.75, 0.25, 0.5, -0.75, 0.5, -0.25, 0.0, 0.25, 0.25, 0.0, -0.5, 1.0, 0.75, 0.0, 0.25, 0.0, 0.25, -0.5, 1.0, -0.25, -0.25, -0.25, -0.75, 0.5, -1.0, -0.5, 0.0, -0.5, ]);
    ...
    compute_pass_encoder0020.insertDebugMarker("marker")
    const array4 = new Float32Array([-0.5, -1.0, -0.5, -1.0, -0.5, -1.0, -0.25, 1.0, -1.0, 0.5, -1.0, -1.0, 1.0, -1.0, 0.75, -0.5, 0.5, 0.5, -0.5, 0.0, -0.5, -0.75, 0.75, -0.75, -0.25, 1.0, 0.5, 0.0, -1.0, 0.0, -0.5, -1.0, -1.0, -1.0, 1.0, -0.5, 0.75, 0.75, 1.0, 0.25, 0.5, 0.0, 1.0, -0.25, 0.5, 0.0, 0.25, -0.5, -0.5, -0.75, 0.0, -0.5, 0.75, -1.0, 0.75, -0.25, 0.0, 1.0, 0.75, 0.5, -1.0, -0.5, -0.5, 0.25, 0.0, 0.5, -1.0, 0.0, -0.25, 0.25, 0.75, -0.5, 0.25, -1.0, -0.25, -0.5, 0.25, 1.0, 0.25, 1.0, 0.75, 0.0, 0.25, -1.0, 0.75, 0.25, 0.25, -0.25, 1.0, -0.75, 0.5, 1.0, -0.5, 1.0, -0.75, -1.0, -0.75, 0.0, 0.25, 1.0, ]);
    ...
    device00.queue.writeTexture({ texture: texture001 }, array2, { bytesPerRow: 40, rowsPerImage: 10 }, { width: 10, height: 10 });
    const array5 = new Float32Array([1.0, 0.25, -1.0, -0.5, -0.75, 0.75, 0.0, -0.5, 0.0, 0.5, -0.25, -0.25, -1.0, 0.75, -0.5, 0.25, 0.0, -0.25, -0.5, -1.0, 1.0, 0.25, -0.75, 1.0, -0.25, 0.0, 1.0, 0.75, -1.0, -0.75, -0.25, -0.75, -0.25, -0.75, 1.0, 0.25, 1.0, -0.5, 0.75, -1.0, -1.0, 0.5, 1.0, -1.0, 0.0, 0.0, 0.5, 0.25, 1.0, 0.75, 1.0, 0.5, 0.75, 0.75, 0.75, 0.5, -0.25, 0.25, -0.25, 1.0, 0.75, -1.0, 0.75, 0.25, -1.0, 0.5, 0.5, 0.0, 0.25, 0.75, 0.75, -0.25, 0.25, -0.5, -1.0, -1.0, 0.25, -0.25, -0.5, 1.0, 0.75, -1.0, -0.25, -1.0, -1.0, -0.5, 0.0, 0.5, -0.25, 0.5, -0.75, 0.0, -1.0, 0.5, 0.5, -0.25, -1.0, 1.0, -1.0, 0.25, ]);
    ...
    const array6 = new Float32Array([-0.75, -0.75, 1.0, 0.0, -0.25, -0.25, 0.25, -0.5, 0.25, -0.5, 0.0, 0.25, 0.75, 0.75, -0.25, -1.0, 1.0, 0.75, -0.5, -0.75, -1.0, -0.5, 1.0, 0.5, -0.5, -1.0, -1.0, 1.0, -0.25, 0.75, 0.25, 0.75, -0.5, 0.0, -0.25, -0.25, 1.0, 0.25, -1.0, 1.0, 1.0, -0.5, -0.5, 0.0, 1.0, -1.0, -0.25, 0.25, 0.5, -0.75, -0.5, 0.0, 0.75, -0.25, 0.5, 0.25, -0.75, -0.25, 0.0, 1.0, 1.0, 0.0, 0.25, 0.75, -0.5, -0.25, -0.75, -0.25, -0.5, 0.5, 0.25, 0.5, 0.5, -0.5, 0.5, -0.75, -1.0, 0.25, -0.5, 0.25, -0.5, 0.0, 0.75, -1.0, -0.5, -0.5, 1.0, -0.75, 0.25, -0.25, -1.0, 0.5, -1.0, -0.75, -0.25, 0.5, -1.0, -1.0, 0.75, -0.25, ]);
    ...
    const array7 = new Float32Array([1.0, 0.5, -0.5, -0.5, -0.25, -0.75, 0.75, 1.0, 1.0, -0.75, 0.25, 1.0, -0.75, 0.25, 0.75, 0.75, -1.0, 0.5, -0.5, 0.0, -1.0, 1.0, -1.0, -0.25, 0.5, -0.25, -1.0, 0.25, -1.0, 0.75, -1.0, 0.0, 1.0, 0.75, 0.0, 0.5, -1.0, -0.25, 0.75, 0.75, -0.5, -1.0, -0.75, 0.5, 0.25, -0.25, 0.25, 1.0, -1.0, -0.75, -0.5, -0.75, 1.0, 0.5, -1.0, -0.75, -0.25, -0.75, 0.25, 0.25, -0.25, -0.5, 0.75, 0.0, -0.5, 0.75, -1.0, 0.75, -0.25, 1.0, 0.75, 0.5, -0.25, -1.0, 0.75, 0.5, 0.0, 0.25, 0.0, 0.75, 0.5, -0.75, 0.0, -0.25, 0.25, 0.5, -0.5, 0.75, -0.5, 1.0, -0.75, -0.25, -1.0, 0.0, -1.0, 0.25, 0.0, 0.0, 0.25, 0.0, ]);
    ...
    const render_pipeline0052 = device00.createRenderPipeline({
        label: "render_pipeline0052",
        vertex: {
            module: shader_module002,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0053 = device00.createRenderPipeline({
        label: "render_pipeline0053",
        vertex: {
            module: shader_module008,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0054 = device00.createRenderPipeline({
        label: "render_pipeline0054",
        vertex: {
    ...
    const render_pipeline0055 = device00.createRenderPipeline({
        label: "render_pipeline0055",
        vertex: {
            module: shader_module004,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0056 = device00.createRenderPipeline({
        label: "render_pipeline0056",
        vertex: {
            module: shader_module007,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0057 = device00.createRenderPipeline({
        label: "render_pipeline0057",
        vertex: {
            module: shader_module002,
            entryPoint: "vertex_main",
            buffers: [
    ...
    compute_pass_encoder0030.pushDebugGroup("group_marker")
    const render_pipeline0058 = device00.createRenderPipeline({
        label: "render_pipeline0058",
        vertex: {
            module: shader_module002,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0059 = device00.createRenderPipeline({
        label: "render_pipeline0059",
        vertex: {
            module: shader_module008,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0060 = device00.createRenderPipeline({
        label: "render_pipeline0060",
        vertex: {
            module: shader_module000,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0061 = device00.createRenderPipeline({
        label: "render_pipeline0061",
        vertex: {
            module: shader_module002,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline0062 = device00.createRenderPipeline({
        label: "render_pipeline0062",
        vertex: {
            module: shader_module001,
            entryPoint: "vertex_main",
            buffers: [

...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([0.25, -0.75, 0.75, 0.5, 0.25, -0.75, 1.0, 0.75, 0.0, -0.5, -0.25, 0.5, -0.25, -1.0, -1.0, -1.0, -1.0, 0.5, -1.0, 0.5, 1.0, -0.75, -0.25, -0.25, 1.0, -1.0, 0.25, 1.0, 0.75, 0.25, 0.0, 0.25, 0.75, -0.25, -1.0, -0.25, 1.0, 0.5, -0.25, -0.5, 0.75, -0.25, -0.25, 0.5, 0.75, 0.0, -0.25, -0.25, -0.5, -0.5, -1.0, -0.25, -0.25, -0.25, -0.5, -0.75, -0.25, 1.0, 1.0, 0.0, 0.75, 0.5, 0.5, 1.0, 0.0, -0.25, 0.75, 0.75, 0.5, 0.75, -0.5, 0.0, -0.5, 0.25, 0.75, 0.75, 0.25, 1.0, -0.25, 0.0, 0.5, 0.25, 0.5, -0.25, -0.25, -0.25, -0.75, 1.0, 0.5, -0.25, -0.5, -0.5, 0.75, 1.0, 0.25, 0.0, -0.5, 1.0, 0.25, 0.25, ]);
    const query203 = device20.createQuerySet({
        label: "query203",
        type: "occlusion",
        count: 32,
    });
    const array1 = new Float32Array([0.0, 1.0, -0.25, -1.0, 0.75, 0.0, -0.75, -0.25, -0.25, 0.75, -1.0, 1.0, 0.25, 0.0, -0.75, -0.5, 0.0, -1.0, -0.5, 0.5, -0.75, 0.0, 1.0, 0.0, -1.0, -0.25, 0.0, -0.5, -0.25, 0.75, 0.75, 0.5, 0.25, 0.25, 0.0, 0.25, -0.75, -1.0, 1.0, 0.5, 0.0, -1.0, 0.5, 1.0, -0.75, 0.75, -0.5, -1.0, 0.25, -0.5, 0.0, 0.25, 0.25, 0.5, -1.0, 1.0, -0.5, 0.5, 0.0, 1.0, 1.0, 0.75, 0.75, 0.5, -1.0, 0.25, 0.75, 0.5, 0.5, 0.5, -0.25, -1.0, 0.0, -0.25, -1.0, 0.5, -0.25, 0.0, 0.25, 0.5, -1.0, -0.25, -0.5, 1.0, 0.0, 0.5, -0.5, 0.75, -0.75, 0.25, -0.25, 0.0, -0.25, 0.0, 0.75, -0.25, 1.0, -0.25, 1.0, 0.25, ]);
    query200.destroy()
    render_pass_encoder0000.setScissorRect(0, 0, texture000.width / 2, texture000.height / 2);
    device30.popErrorScope().then((error) => {
        if (error) {
    ...
    compute_pass_encoder4020.setPipeline(compute_pipeline4012);
    query202.destroy()
    query300.destroy()
    compute_pass_encoder2010.insertDebugMarker("marker")
    query203.destroy()
    ...
    const bind_group401 = device40.createBindGroup({
        label: "bind_group401",
        layout: compute_pipeline4012.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {

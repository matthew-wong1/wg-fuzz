...
async function main(gpu: GPU) {
    ...
    const texture_view9060 = texture906.createView({ label: "texture_view9060" });
    ...
    const texture_view9061 = texture906.createView({ label: "texture_view9061" });
    ...
    const query908 = device90.createQuerySet({
        label: "query908",
        type: "occlusion",
        count: 32,
    });
    ...
    try {
        shader_module1108_code = await fs.readFile(__dirname + '/shader_module1108.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const query909 = device90.createQuerySet({
        label: "query909",
        type: "occlusion",
        count: 32,
    });

...
async function main(gpu: GPU) {
    ...
    const render_pipeline1068 = device10.createRenderPipeline({
        label: "render_pipeline1068",
        vertex: {
            module: shader_module108,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline1069 = device10.createRenderPipeline({
        label: "render_pipeline1069",
        vertex: {
    ...
    const render_pipeline1070 = device10.createRenderPipeline({
        label: "render_pipeline1070",
        vertex: {
            module: shader_module103,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline1071 = device10.createRenderPipeline({
        label: "render_pipeline1071",
        vertex: {
            module: shader_module1010,
            entryPoint: "vertex_main",
            buffers: [

...
async function main(gpu: GPU) {
    ...
    device00.queue.writeTexture({ texture: texture001 }, array1, { bytesPerRow: 40, rowsPerImage: 10 }, { width: 10, height: 10 });
    const array3 = new Float32Array([-0.25, 0.0, 0.25, -0.75, -0.25, 0.75, -0.75, 0.5, -1.0, 0.75, -0.75, 0.5, 0.25, -1.0, -0.75, -0.5, 0.75, 0.0, 0.0, 0.0, 0.0, -0.75, -1.0, -0.25, 0.25, 1.0, 0.0, 0.5, 1.0, -1.0, 1.0, -1.0, 0.75, -0.25, -0.5, -0.25, 1.0, -0.75, 0.75, 1.0, 0.75, 1.0, 0.25, 0.0, 0.75, -0.75, 0.25, -0.5, -0.25, 1.0, -0.25, -0.5, 0.75, -0.5, -0.5, -1.0, -1.0, -1.0, 0.5, 0.75, 0.25, 0.25, 0.25, -0.75, -1.0, 0.5, -0.25, 0.5, -0.5, 0.5, 1.0, -0.5, 0.0, -1.0, -1.0, 1.0, -0.5, 0.75, 0.25, 0.75, 1.0, 0.5, -0.25, 0.25, -0.5, 0.0, -0.25, -0.75, -0.75, 0.25, -0.5, 0.0, 0.25, -0.5, 0.0, 0.0, 0.75, -0.75, 0.5, 0.25, ]);
    query003.destroy()

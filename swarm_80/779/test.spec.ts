...
async function main(gpu: GPU) {
    ...
    device20.queue.writeBuffer(buffer206, 0, uint32_2030, 0, uint32_2030.length);

    compute_pass_encoder2030.dispatchWorkgroupsIndirect(buffer206, 0);
    ...
    compute_pass_encoder0031.setPipeline(compute_pipeline0036);
    ...
    compute_pass_encoder0031.setBindGroup(0, bind_group005);
    ...
    device20.queue.writeBuffer(buffer2023, 0, uint32_2050, 0, uint32_2050.length);

    compute_pass_encoder2050.dispatchWorkgroupsIndirect(buffer2023, 0);

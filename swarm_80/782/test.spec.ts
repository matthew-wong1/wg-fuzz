...
async function main(gpu: GPU) {
    ...
    render_bundle_encoder1502.popDebugGroup();
    ...
    const render_pipeline1108 = device110.createRenderPipeline({
        label: "render_pipeline1108",
        vertex: {
            module: shader_module1101,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline1505 = device150.createRenderPipeline({
        label: "render_pipeline1505",
        vertex: {
            module: shader_module1502,
            entryPoint: "vertex_main",
            buffers: [

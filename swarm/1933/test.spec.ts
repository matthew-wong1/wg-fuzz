...
async function main(gpu: GPU) {
    ...
    compute_pass_encoder2011.setPipeline(compute_pipeline203);
    ...
    device20.queue.writeBuffer(buffer2032, 0, uint32_2040, 0, uint32_2040.length);

    compute_pass_encoder2040.dispatchWorkgroupsIndirect(buffer2032, 0);
    const uint32_2011 = new Uint32Array(3);
    ...
    device20.queue.writeBuffer(buffer2036, 0, uint32_2011, 0, uint32_2011.length);

    compute_pass_encoder2011.dispatchWorkgroupsIndirect(buffer2036, 0);
    const uint32_2011 = new Uint32Array(3);

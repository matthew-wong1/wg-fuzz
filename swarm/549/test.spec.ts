...
async function main(gpu: GPU) {
    ...
    const array2 = new Float32Array([0.5, 1.0, 0.0, 0.5, 1.0, -0.25, -0.75, 0.75, 0.75, 0.75, 1.0, -1.0, 0.25, 0.75, -0.75, 0.5, -0.75, 1.0, 0.75, -1.0, -0.5, 1.0, -0.5, -0.5, -0.25, 1.0, -0.25, 0.5, -0.5, -0.5, 0.75, 1.0, -0.5, -0.75, -0.25, 1.0, 0.0, -0.75, 0.0, 0.0, -0.75, 1.0, -1.0, 0.5, -1.0, -0.75, -0.75, 0.5, -0.75, -0.25, -0.25, 0.75, 1.0, 0.75, 0.25, -1.0, 0.5, -1.0, 1.0, 0.0, 0.5, -0.25, -0.5, -0.25, 0.75, -1.0, 1.0, 1.0, -1.0, 0.75, -0.25, 0.25, -0.75, 0.5, 0.75, -1.0, 1.0, 1.0, -0.5, 1.0, 1.0, 0.25, 0.25, -1.0, -0.25, 1.0, 1.0, 1.0, -0.75, -0.5, 0.5, 0.5, 0.75, 1.0, 1.0, -0.5, -0.75, -0.75, 0.25, 0.5, ]);
    ...
    const array3 = new Float32Array([-0.5, 0.25, 1.0, 0.0, -0.25, -1.0, -0.25, 1.0, 0.5, 0.0, -0.5, 0.5, -0.25, 0.25, 0.5, -0.5, 0.25, -0.5, 0.5, 0.75, -1.0, 0.25, 1.0, 1.0, 0.5, 1.0, 0.25, 0.25, 1.0, 0.25, 0.5, 0.5, -0.25, -0.25, 0.0, 0.75, 0.25, -0.5, 0.25, -0.25, 0.25, -1.0, 0.75, 0.25, -0.5, -0.75, -0.25, 1.0, -1.0, 0.5, -0.25, 1.0, 0.5, -0.75, -1.0, 0.0, 1.0, 0.75, 1.0, 1.0, 0.75, -1.0, 0.0, 1.0, -0.5, 0.75, 1.0, 0.25, 0.25, 0.25, -0.5, -0.5, 0.0, 1.0, -1.0, -0.5, 0.25, 0.75, 1.0, 0.5, 0.5, 0.5, -0.5, 0.75, 1.0, 0.25, 0.75, -1.0, -0.5, -0.25, 0.0, -0.75, -1.0, 0.5, 0.75, -1.0, -0.5, 0.5, 0.75, 0.25, ]);
    ...
    const array4 = new Float32Array([-0.75, -0.5, 0.5, 0.75, 1.0, 0.0, -1.0, -0.75, -1.0, -1.0, 0.0, 0.25, -0.25, 1.0, -1.0, 1.0, 0.0, 0.5, 0.5, 1.0, 0.0, -0.5, -0.75, 0.25, -0.25, 1.0, -0.75, -0.25, -0.75, -1.0, 1.0, -0.75, 1.0, 0.25, 0.0, 0.5, 0.25, -0.75, 0.0, 0.5, 0.25, 0.0, 0.0, -1.0, -1.0, -1.0, -0.75, 0.75, -1.0, 0.5, 0.25, -0.25, 0.0, 0.0, 0.5, -0.5, 0.5, 0.75, 0.0, -1.0, -1.0, 0.25, 0.5, 0.0, -0.75, 0.25, 1.0, 0.25, 0.75, 1.0, -0.25, -1.0, 0.5, -0.25, 0.0, 1.0, -0.75, -1.0, 0.75, 0.25, -0.75, 0.25, 0.5, 0.75, -0.75, 0.75, 1.0, 1.0, -0.5, 0.5, 1.0, 0.5, 0.25, 0.0, 0.5, -0.5, -0.75, -1.0, 0.0, -0.25, ]);
    ...
    render_pass_encoder2080.setViewport(0, 0, texture205.width / 2, texture205.height / 2, 0, 1);
    render_pass_encoder2010.setScissorRect(0, 0, texture200.width / 2, texture200.height / 2);
    ...
    render_pass_encoder2080.setPipeline(render_pipeline200);
    device10.popErrorScope().then((error) => {
        if (error) {
            console.error(`An error occurred: ${error.message}`);
        }

...
async function main(gpu: GPU) {
    ...
    const array2 = new Float32Array([-1.0, 0.25, 0.25, 0.5, -1.0, 0.75, 0.0, -0.75, -1.0, 0.5, 0.0, -0.5, -1.0, 0.75, 0.5, -0.5, 0.75, -0.75, 0.0, -0.25, 0.75, 0.0, 0.25, 0.75, -0.5, -0.75, 0.5, 1.0, 0.75, -1.0, -0.75, 0.75, 1.0, -1.0, -0.5, 0.0, -0.25, 0.5, 1.0, -0.5, -1.0, -0.25, 0.0, 0.75, -1.0, -0.25, 0.75, 0.5, 0.75, 0.25, 0.25, -0.75, 0.75, 0.25, -0.25, 0.25, 0.0, 0.25, 0.0, -1.0, 0.75, -0.75, 0.0, 0.25, -1.0, -1.0, -0.25, 0.25, 0.0, 0.25, 0.0, -0.25, -1.0, 0.0, 0.0, 1.0, 0.75, 0.5, 0.75, -0.5, -0.5, -0.75, 1.0, 0.75, 0.75, 0.25, 0.25, -0.75, 0.25, 0.0, -0.75, -0.5, 1.0, 0.0, -1.0, -0.25, -0.75, 0.5, 0.25, 0.5, ]);
    ...
    compute_pass_encoder3011.setPipeline(compute_pipeline304);
    ...
    const array3 = new Float32Array([0.0, 0.75, 0.0, 0.25, 0.75, -1.0, 1.0, -0.5, 0.5, -1.0, 0.0, 1.0, -0.5, 0.75, 1.0, 1.0, 1.0, -0.25, 0.0, -0.25, -0.25, 0.5, 0.75, 1.0, 0.0, -0.5, 0.75, -1.0, 0.25, 1.0, 0.25, 0.5, 1.0, -0.5, 0.0, -0.25, 0.0, 1.0, -0.5, -0.25, -0.25, 1.0, -1.0, -1.0, -0.5, 0.75, 0.5, -0.75, -0.75, -0.75, -0.25, -1.0, -0.25, 0.25, 0.5, 0.0, 0.75, -0.5, -0.25, -0.25, 0.25, 1.0, -1.0, 0.0, 0.25, 0.25, 0.75, 0.25, 0.25, 0.75, 1.0, 1.0, -0.25, -0.75, -1.0, 0.0, -0.5, 0.0, -0.25, -0.25, 0.25, -0.25, 0.25, -0.5, 0.0, -1.0, 0.5, 0.75, 0.5, 0.5, 0.25, -0.75, 0.25, 0.0, -0.75, -0.25, -0.5, 0.0, 0.0, 0.25, ]);
    ...
    device30.queue.writeBuffer(buffer3018, 0, uint32_3011, 0, uint32_3011.length);

    compute_pass_encoder3011.dispatchWorkgroupsIndirect(buffer3018, 0);
    compute_pass_encoder3010.popDebugGroup()
    device00.queue.submit([command_buffer001, ]);

...
async function main(gpu: GPU) {
    ...
    texture800.destroy();
    const texture_view7061 = texture706.createView({ label: "texture_view7061" });
    ...
    try {
        shader_module7011_code = await fs.readFile('/Users/matthew/Documents/msc/final_proj/dawn_coverage_final/third_party/webgpu-cts/src/webgpu/api/operation/wg_fuzz/shader_module7011.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module7011 = await device70.createShaderModule({ label: "shader_module7011", code: shader_module7011_code })
    const texture_view7081 = texture708.createView({ label: "texture_view7081" });
    ...
    try {
        shader_module7012_code = await fs.readFile('/Users/matthew/Documents/msc/final_proj/dawn_coverage_final/third_party/webgpu-cts/src/webgpu/api/operation/wg_fuzz/shader_module7012.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module7013_code = await fs.readFile('/Users/matthew/Documents/msc/final_proj/dawn_coverage_final/third_party/webgpu-cts/src/webgpu/api/operation/wg_fuzz/render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }

...
async function main(gpu: GPU) {
    ...
    const texture_view13030 = texture1303.createView({ label: "texture_view13030" });
    ...
    render_bundle_encoder1302.insertDebugMarker("marker");
    ...
    const texture_view13050 = texture1305.createView({ label: "texture_view13050" });
    ...
    const texture_view13051 = texture1305.createView({ label: "texture_view13051" });
    texture1305.destroy();
    ...
    const pipeline_layout1402 = device140.createPipelineLayout({ 
        ...
        bindGroupLayouts: [bind_group_layout1404]
    });
    ...
    const compute_pipeline1401 = device140.createComputePipeline({
        label: "compute_pipeline1401",
        layout: pipeline_layout1400,
        compute: {

...
async function main(gpu: GPU) {
    ...
    const render_bundle_encoder1003 = device100.createRenderBundleEncoder({
        label: "render_bundle_encoder1003",
        colorFormats: ["bgra8unorm"]
    });
    ...
    render_bundle_encoder1003.pushDebugGroup("group_marker");

...
async function main(gpu: GPU) {
    ...
    const array0 = new Float32Array([-0.75, -1.0, 1.0, 0.5, -1.0, -0.75, -0.25, -0.25, 0.5, 0.75, -0.75, -0.75, 0.25, 0.75, 0.0, -1.0, 0.25, 0.75, 0.5, 1.0, -0.5, -0.25, 0.25, -0.75, 0.0, 0.5, -0.75, 0.75, -0.25, -1.0, 0.25, 0.5, -0.5, -0.25, -0.25, 0.75, 0.75, -0.75, 0.5, 0.5, 1.0, 0.5, -0.25, -1.0, -1.0, 0.0, 0.75, 0.25, -0.75, 0.75, 0.5, -0.5, -1.0, -1.0, 0.75, 1.0, -0.75, 1.0, 0.0, -0.25, 0.25, -0.25, 1.0, 0.75, 0.25, 0.25, 0.5, -1.0, -0.5, 0.25, -0.25, 0.0, 0.75, -0.25, 0.0, 0.75, -1.0, -1.0, 0.0, 0.5, -0.5, 0.0, -0.5, 0.25, -0.5, 0.25, -0.75, 0.5, -0.5, 0.0, 0.25, 0.25, -0.25, 0.25, 0.25, -1.0, -0.5, -0.75, -0.75, 0.75, ]);
    const array1 = new Float32Array([-0.25, 1.0, -0.25, -1.0, 0.25, -0.25, 0.0, 0.25, 1.0, 0.5, -0.25, 0.5, -0.25, 0.0, 1.0, -0.5, 0.0, -1.0, -0.5, 0.0, -0.25, 0.75, 1.0, 0.0, -0.5, -1.0, 0.0, 0.25, 0.0, 0.75, 0.5, -0.25, -0.5, 0.5, -0.25, 0.25, -1.0, 0.0, 0.75, 1.0, -0.5, 0.0, 1.0, -0.75, -0.25, 0.5, -1.0, 1.0, -0.5, 0.25, -0.25, -0.5, 0.75, 0.75, -1.0, 1.0, -0.5, -0.5, 0.5, 0.25, 0.25, -0.25, -0.75, 0.75, 0.5, -1.0, -0.5, -1.0, 0.75, 0.5, -1.0, -0.5, 0.75, -1.0, -0.75, 1.0, -0.25, 0.25, 0.75, 1.0, 0.0, -0.5, 0.5, 0.0, 0.75, 0.0, -0.5, -0.75, -1.0, 0.0, 0.5, -0.75, -1.0, -0.25, -0.25, 0.25, 0.0, -0.25, -1.0, 0.25, ]);
    const adapter0 = await gpu.requestAdapter({
        powerPreference: "high-performance"
    });
    const array2 = new Float32Array([-0.25, 0.75, -0.25, 0.75, 0.25, -0.25, 0.0, -1.0, -0.75, 0.0, 1.0, -0.75, 1.0, -0.75, -0.75, -1.0, 0.75, -0.5, -0.25, 0.0, -1.0, -1.0, 0.0, -0.25, 1.0, 0.25, -0.5, -0.25, -0.75, 0.25, 1.0, 0.75, -0.25, 0.5, -0.25, 1.0, 0.0, 1.0, -0.5, -1.0, -1.0, -1.0, 0.0, 0.0, 0.25, 0.0, -1.0, 0.0, 0.25, -0.25, 0.75, -1.0, 0.75, 0.25, 1.0, 0.75, 0.25, -0.25, -0.5, -0.25, -1.0, -0.5, -0.25, 0.75, 0.5, -0.75, -0.75, 0.0, -0.25, 0.5, 0.0, 1.0, -0.5, -0.75, 1.0, 1.0, 0.5, 0.25, 0.5, 1.0, 0.25, -0.75, 1.0, -0.75, -0.5, 0.75, 1.0, 0.25, -0.75, 0.25, -0.75, -0.75, 0.5, -0.5, -0.25, 0.25, 0.0, 1.0, 0.0, -1.0, ]);
    ...
    render_bundle_encoder400.setVertexBuffer(0, buffer406);
    ...
    render_bundle_encoder403.setBindGroup(0, bind_group403);
    ...
    render_bundle_encoder403.setVertexBuffer(0, buffer406);
    render_bundle_encoder402.insertDebugMarker("marker");
    ...
    render_bundle_encoder402.insertDebugMarker("marker");
    render_bundle_encoder403.setIndexBuffer(buffer403, "uint16");
    ...
    const array6 = new Float32Array([1.0, 0.0, -0.25, 0.0, -0.25, -0.75, -0.5, 0.0, 0.75, 0.25, -0.25, 0.5, 0.25, 1.0, -0.75, -0.25, 0.0, -0.25, 0.0, 0.5, -0.25, -0.5, -1.0, 0.75, 0.5, -0.75, -0.75, -1.0, 0.75, -0.5, -1.0, 0.0, -0.25, 0.25, 1.0, -0.5, 0.0, -0.75, 0.5, 1.0, -0.25, -0.25, 0.5, 0.0, 0.5, -0.5, -1.0, -0.25, 0.0, -0.25, 0.0, 1.0, 0.25, -0.75, 1.0, -0.5, 0.0, 0.75, 0.0, 1.0, 1.0, 0.0, -0.5, -1.0, 0.25, 1.0, -0.25, 0.0, 0.25, -0.75, -1.0, -1.0, 0.75, -0.75, -0.25, 0.5, 1.0, -1.0, -0.75, -0.5, 0.5, -0.25, -0.5, 0.75, 0.5, 0.75, -0.75, 0.75, -0.25, -0.25, -0.5, -0.5, 0.5, -0.5, 0.5, -0.25, 0.0, 0.5, 0.75, -0.25, ]);
    buffer302.destroy()
    ...
    render_bundle_encoder403.draw(3);
    ...
    render_bundle_encoder301.drawIndexedIndirect(buffer300, 0);
    ...
    render_bundle_encoder302.setIndexBuffer(buffer309, "uint16");
    ...
    render_bundle_encoder403.setIndexBuffer(buffer406, "uint16");

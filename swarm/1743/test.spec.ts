...
async function main(gpu: GPU) {
    ...
    const array3 = new Float32Array([0.5, 0.5, 1.0, 0.25, 0.75, 0.25, 0.0, -1.0, -0.75, -0.75, 0.0, -0.75, 1.0, 1.0, -1.0, 0.75, 0.25, -0.25, -0.75, 0.5, -0.25, 0.0, -0.25, -0.75, -0.25, -0.5, -0.5, -1.0, -0.25, -0.5, 0.0, 1.0, 0.25, 0.5, 0.75, -1.0, 1.0, -0.75, 0.75, -0.5, -0.5, -0.75, 0.0, 0.0, -0.75, 0.5, 0.25, 0.0, -0.75, 0.25, -0.75, 0.25, 0.25, -0.5, -0.75, -1.0, 1.0, -1.0, 0.75, 0.5, 0.25, -0.75, -0.5, -1.0, 0.25, -0.5, 1.0, 0.75, 0.5, -1.0, 0.0, 0.0, 1.0, 1.0, 1.0, -0.75, 1.0, -0.5, -0.75, -0.5, -0.5, 0.5, -0.25, -0.75, -0.5, 0.5, 1.0, -0.5, 1.0, 0.5, -1.0, -0.5, -0.25, -1.0, 1.0, -1.0, -0.75, 0.75, -0.25, 0.25, ]);
    ...
    device30.queue.writeBuffer(buffer3017, 0, array1, 0, array1.length);
    command_encoder308.pushDebugGroup("mygroupmarker")
    command_encoder308.clearBuffer(buffer3014);
    compute_pass_encoder0000.pushDebugGroup("group_marker")
    ...
    compute_pass_encoder3070.setPipeline(compute_pipeline303);
    ...
    compute_pass_encoder3070.setBindGroup(0, bind_group309);
    device30.queue.submit([command_buffer300, command_buffer307, command_buffer308, ]);
    ...
    compute_pass_encoder3070.setBindGroup(0, bind_group3012);
    compute_pass_encoder3070.dispatchWorkgroups(100);
    device30.queue.submit([command_buffer304, ]);
    compute_pass_encoder0000.end();
    ...
    device30.queue.writeBuffer(buffer3034, 0, uint32_3070, 0, uint32_3070.length);

    compute_pass_encoder3070.dispatchWorkgroupsIndirect(buffer3034, 0);

...
async function main(gpu: GPU) {
    ...
    const array1 = new Float32Array([-0.25, -0.5, 0.25, 0.5, 0.5, 0.75, 0.75, -0.5, -0.25, -0.25, 0.25, 0.75, -0.5, 0.75, 0.25, 1.0, 0.0, -0.75, 1.0, 0.75, -1.0, -1.0, 0.75, 0.25, 1.0, -1.0, 0.5, 1.0, -0.5, -0.75, 0.25, -1.0, -0.25, 0.25, 1.0, 0.75, -0.25, -0.75, -0.75, 0.75, 0.0, 1.0, -0.75, -1.0, -0.5, 0.0, 0.0, -0.25, 1.0, -1.0, 0.5, -1.0, 0.25, 1.0, 0.75, -1.0, 0.75, 0.5, 1.0, -0.75, 0.25, 0.0, 1.0, -0.75, -0.75, -1.0, -0.5, 0.5, -0.75, 0.0, -0.75, -0.25, 0.25, 0.5, 0.25, 1.0, -0.5, 0.5, -1.0, -1.0, 0.75, 0.25, 0.75, 1.0, -0.25, -0.75, 0.5, 1.0, 0.75, 0.25, 0.0, -1.0, -0.5, 0.75, -0.25, 0.0, -0.25, 0.75, 1.0, 0.75, ]);
    ...
    const array2 = new Float32Array([-0.25, 0.75, -0.5, 0.0, -0.75, -0.5, -0.5, 0.0, 0.5, 0.5, 0.5, -1.0, -0.25, -1.0, -0.5, 0.5, -0.75, -0.75, 0.0, 0.75, 0.75, -1.0, -0.5, -0.5, 0.75, -1.0, -0.5, 0.75, 0.5, 0.0, -0.75, 0.0, -1.0, 0.0, -0.75, -0.5, -0.75, 0.0, -0.25, 1.0, -0.25, 1.0, 0.75, -0.25, -0.75, -0.25, -0.25, -0.25, -0.25, 0.5, 0.5, -0.75, -0.5, -0.5, -0.75, 0.75, -0.25, 1.0, -1.0, 0.25, 0.0, -0.25, 0.5, 1.0, -0.25, -1.0, -0.75, 0.0, -0.75, 0.5, 0.5, 0.25, 0.5, -0.5, -0.25, -0.5, -0.5, 0.0, -0.5, 0.25, -1.0, 0.5, 1.0, 1.0, -0.5, -0.75, -0.5, -0.75, -0.25, -0.25, -1.0, 0.25, 0.75, 0.25, 0.5, 0.0, -1.0, 0.25, 1.0, 1.0, ]);
    ...
    device20.queue.writeBuffer(buffer2013, 0, uint32_2011, 0, uint32_2011.length);

    compute_pass_encoder2011.dispatchWorkgroupsIndirect(buffer2013, 0);
    ...
    device20.queue.writeBuffer(buffer2025, 0, uint32_2020, 0, uint32_2020.length);

    compute_pass_encoder2020.dispatchWorkgroupsIndirect(buffer2025, 0);
    ...
    device20.queue.writeBuffer(buffer2042, 0, uint32_2011, 0, uint32_2011.length);

    compute_pass_encoder2011.dispatchWorkgroupsIndirect(buffer2042, 0);
    compute_pass_encoder2030.popDebugGroup()
    compute_pass_encoder2000.end();
    ...
    device20.queue.writeBuffer(buffer2043, 0, uint32_2011, 0, uint32_2011.length);

    compute_pass_encoder2011.dispatchWorkgroupsIndirect(buffer2043, 0);
    ...
    device20.queue.writeBuffer(buffer2057, 0, uint32_2020, 0, uint32_2020.length);

    compute_pass_encoder2020.dispatchWorkgroupsIndirect(buffer2057, 0);
    compute_pass_encoder0020.end();
    compute_pass_encoder0010.dispatchWorkgroups(100);
    ...
    device20.queue.writeBuffer(buffer2075, 0, uint32_2020, 0, uint32_2020.length);

    compute_pass_encoder2020.dispatchWorkgroupsIndirect(buffer2075, 0);
    device20.queue.submit([command_buffer203, ]);
    device00.queue.submit([command_buffer004, ]);
    compute_pass_encoder2000.popDebugGroup()
    device20.queue.submit([command_buffer204, ]);
    ...
    device00.queue.writeBuffer(buffer0076, 0, uint32_0030, 0, uint32_0030.length);

    compute_pass_encoder0030.dispatchWorkgroupsIndirect(buffer0076, 0);
    ...
    device00.queue.writeBuffer(buffer0078, 0, uint32_0020, 0, uint32_0020.length);

    compute_pass_encoder0020.dispatchWorkgroupsIndirect(buffer0078, 0);
    compute_pass_encoder0020.popDebugGroup()
    ...
    device20.queue.writeBuffer(buffer2082, 0, uint32_2030, 0, uint32_2030.length);

    compute_pass_encoder2030.dispatchWorkgroupsIndirect(buffer2082, 0);
    compute_pass_encoder2010.popDebugGroup()
    compute_pass_encoder2010.dispatchWorkgroups(100);
    compute_pass_encoder0020.end();
    compute_pass_encoder0030.popDebugGroup()
    ...
    device20.queue.writeBuffer(buffer2084, 0, uint32_2010, 0, uint32_2010.length);

    compute_pass_encoder2010.dispatchWorkgroupsIndirect(buffer2084, 0);
    const uint32_2020 = new Uint32Array(3);
    ...
    device20.queue.writeBuffer(buffer2085, 0, uint32_2020, 0, uint32_2020.length);

    compute_pass_encoder2020.dispatchWorkgroupsIndirect(buffer2085, 0);
    compute_pass_encoder5000.popDebugGroup()
    compute_pass_encoder2010.dispatchWorkgroups(100);
    const uint32_2030 = new Uint32Array(3);
    ...
    device00.queue.writeBuffer(buffer0089, 0, uint32_0010, 0, uint32_0010.length);

    compute_pass_encoder0010.dispatchWorkgroupsIndirect(buffer0089, 0);
    compute_pass_encoder2011.popDebugGroup()
    compute_pass_encoder0030.popDebugGroup()
    compute_pass_encoder0011.dispatchWorkgroups(100);
    device20.queue.submit([command_buffer203, ]);
    ...
    device20.queue.writeBuffer(buffer2096, 0, uint32_2000, 0, uint32_2000.length);

    compute_pass_encoder2000.dispatchWorkgroupsIndirect(buffer2096, 0);
    compute_pass_encoder0020.popDebugGroup()
    compute_pass_encoder2030.end();
    compute_pass_encoder2000.popDebugGroup()
    compute_pass_encoder0011.end();
    ...
    device00.queue.writeBuffer(buffer00103, 0, uint32_0000, 0, uint32_0000.length);

    compute_pass_encoder0000.dispatchWorkgroupsIndirect(buffer00103, 0);
    compute_pass_encoder5010.popDebugGroup()
    compute_pass_encoder2010.popDebugGroup()
    ...
    device20.queue.writeBuffer(buffer20108, 0, uint32_2020, 0, uint32_2020.length);

    compute_pass_encoder2020.dispatchWorkgroupsIndirect(buffer20108, 0);
    ...
    device20.queue.writeBuffer(buffer20111, 0, uint32_2030, 0, uint32_2030.length);

    compute_pass_encoder2030.dispatchWorkgroupsIndirect(buffer20111, 0);
    compute_pass_encoder2000.dispatchWorkgroups(100);
    compute_pass_encoder0020.dispatchWorkgroups(100);
    compute_pass_encoder5010.popDebugGroup()
    compute_pass_encoder5010.popDebugGroup()

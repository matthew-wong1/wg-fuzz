...
async function main(gpu: GPU) {
    ...
    const texture_view7006 = texture700.createView({ label: "texture_view7006" });
    ...
    const texture_view7007 = texture700.createView({ label: "texture_view7007" });
    ...
    const texture_view7008 = texture700.createView({ label: "texture_view7008" });

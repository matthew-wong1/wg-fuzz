...
async function main(gpu: GPU) {
    ...
    render_pass_encoder5010.executeBundles([render_bundle_encoder500, ])
    ...
    render_pass_encoder5011.setScissorRect(0, 0, texture504.width / 2, texture504.height / 2);
    ...
    render_pass_encoder5011.setViewport(0, 0, texture504.width / 2, texture504.height / 2, 0, 1);
    ...
    render_pass_encoder5030.setScissorRect(0, 0, texture504.width / 2, texture504.height / 2);
    ...
    render_pass_encoder9000.setScissorRect(0, 0, texture900.width / 2, texture900.height / 2);
    compute_pass_encoder6000.pushDebugGroup("group_marker")
    render_pass_encoder2030.setPipeline(render_pipeline203);
    render_pass_encoder5000.setScissorRect(0, 0, texture505.width / 2, texture505.height / 2);
    render_pass_encoder5000.setViewport(0, 0, texture505.width / 2, texture505.height / 2, 0, 1);
    ...
    render_pass_encoder5012.setViewport(0, 0, texture504.width / 2, texture504.height / 2, 0, 1);
    compute_pass_encoder5001.insertDebugMarker("marker")
    ...
    render_pass_encoder5041.setPipeline(render_pipeline506);

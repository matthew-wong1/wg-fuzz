...
async function main(gpu: GPU) {
    ...
    const array2 = new Float32Array([-0.5, 0.25, -0.75, 0.0, -0.75, 0.0, 0.25, -0.25, -1.0, 1.0, -1.0, 0.25, 0.75, 0.5, 0.75, 0.75, 0.25, 0.0, -0.25, 0.25, 0.25, -0.25, -0.5, -0.25, -0.75, 0.0, 0.25, -0.75, 0.0, -0.75, 1.0, -0.75, -0.25, 0.25, -0.25, -0.5, -0.25, -0.5, 0.75, -0.5, 0.0, -0.75, -0.25, -1.0, 0.5, 0.0, 0.5, 0.0, 0.5, -0.25, -0.5, 0.0, 0.5, 0.5, 0.25, 0.5, 0.75, -0.75, -0.5, -1.0, -0.25, -0.5, 0.25, 1.0, 0.0, -0.75, 0.75, 0.0, -0.75, 0.0, -0.5, 0.25, 1.0, 0.0, -1.0, 1.0, -0.75, -1.0, -1.0, 1.0, 1.0, -0.25, 0.0, 1.0, -0.25, 0.5, -0.75, 0.0, 0.25, 0.0, -0.75, 1.0, -0.5, 0.0, -1.0, 0.75, -0.25, -0.25, 0.0, 0.75, ]);
    ...
    const array3 = new Float32Array([-0.25, 0.75, -1.0, 1.0, 0.0, -1.0, -0.5, -0.25, -1.0, -0.5, -0.75, 1.0, 0.25, 0.5, 0.0, 0.5, 0.75, -0.75, 1.0, -0.75, 0.0, -0.75, -0.75, 0.0, -1.0, -0.25, -0.25, -0.75, 0.0, -0.25, 0.75, -0.25, 0.25, -0.25, 0.75, -0.75, 0.25, 0.5, -1.0, 0.75, 0.5, -1.0, 0.0, -1.0, 0.0, 0.75, 0.5, 0.75, -0.75, -0.25, -1.0, -1.0, -0.5, 0.25, 0.5, -1.0, 1.0, 0.0, 0.25, 0.0, -0.75, -0.75, -1.0, -0.25, -0.5, 1.0, 0.25, -1.0, 0.5, 1.0, -1.0, 1.0, 0.25, -1.0, 1.0, 0.0, 0.5, 0.75, 0.25, -0.25, 0.25, -0.75, -0.25, -0.75, -0.25, 0.25, 0.0, -1.0, 0.25, 1.0, 0.5, -1.0, 0.5, -1.0, 0.5, 0.75, 0.5, -0.25, -1.0, 0.75, ]);
    ...
    device00.queue.writeBuffer(buffer006, 0, uint32_0050, 0, uint32_0050.length);

    compute_pass_encoder0050.dispatchWorkgroupsIndirect(buffer006, 0);

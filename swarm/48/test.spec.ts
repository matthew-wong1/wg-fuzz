...
async function main(gpu: GPU) {
    ...
    device30.queue.writeBuffer(buffer309, 0, uint32_3011, 0, uint32_3011.length);

    compute_pass_encoder3011.dispatchWorkgroupsIndirect(buffer309, 0);
    ...
    compute_pass_encoder1050.setPipeline(compute_pipeline1014);
    ...
    device10.queue.writeBuffer(buffer105, 0, uint32_1050, 0, uint32_1050.length);

    compute_pass_encoder1050.dispatchWorkgroupsIndirect(buffer105, 0);
    ...
    compute_pass_encoder3020.setPipeline(compute_pipeline3018);
    ...
    const bind_group303 = device30.createBindGroup({
        label: "bind_group303",
        layout: compute_pipeline3018.getBindGroupLayout(0),
        entries: [
            {
                binding: 0,
                resource: {

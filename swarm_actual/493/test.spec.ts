...
async function main(gpu: GPU) {
    ...
    device20.queue.submit([command_buffer2010, ]);
    ...
    const pipeline_layout2038 = device20.createPipelineLayout({ 
        ...
        bindGroupLayouts: [bind_group_layout2012]
    });
    ...
    const command_buffer2012 = command_encoder2012.finish();
    ...
    device20.queue.submit([command_buffer2011, ]);
}
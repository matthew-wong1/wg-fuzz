...
async function main(gpu: GPU) {
    ...
    const buffer1901 = device190.createBuffer({
        label: "buffer1901",
        size: 400,
        usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ
    });
    ...
    const render_pipeline1903 = device190.createRenderPipeline({
        label: "render_pipeline1903",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    buffer2000.destroy()
    const render_pipeline1904 = device190.createRenderPipeline({
        label: "render_pipeline1904",
        vertex: {
            module: shader_module1901,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline1905 = device190.createRenderPipeline({
        label: "render_pipeline1905",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline1906 = device190.createRenderPipeline({
        label: "render_pipeline1906",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const buffer1902 = device190.createBuffer({
        label: "buffer1902",
        size: 400,
        usage: GPUBufferUsage.UNIFORM
    });
    ...
    const render_pipeline1907 = device190.createRenderPipeline({
        label: "render_pipeline1907",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline1908 = device190.createRenderPipeline({
        label: "render_pipeline1908",
        vertex: {
            module: shader_module1901,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline1909 = device190.createRenderPipeline({
        label: "render_pipeline1909",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19010 = device190.createRenderPipeline({
        label: "render_pipeline19010",
        vertex: {
            module: shader_module1901,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const buffer1903 = device190.createBuffer({
        label: "buffer1903",
        size: 400,
        usage: GPUBufferUsage.COPY_DST
    });
    
    var shader_module1903_code = "";
    try {
        shader_module1903_code = await fs.readFile(__dirname + '/render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module1903 = await device190.createShaderModule({ label: "shader_module1903", code: shader_module1903_code })
    var shader_module1904_code = "";
    try {
        shader_module1904_code = await fs.readFile(__dirname + '/render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module1904 = await device190.createShaderModule({ label: "shader_module1904", code: shader_module1904_code })
    
    const render_pipeline19011 = device190.createRenderPipeline({
        label: "render_pipeline19011",
        vertex: {
            module: shader_module1904,
            entryPoint: "vertex_main",
            buffers: [
                {
                    attributes: [
    ...
    const render_pipeline19012 = device190.createRenderPipeline({
        label: "render_pipeline19012",
        vertex: {
            module: shader_module1903,
            entryPoint: "vertex_main",
            buffers: [
                {
                    attributes: [
    ...
    const render_pipeline19013 = device190.createRenderPipeline({
        label: "render_pipeline19013",
        vertex: {
            module: shader_module1904,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const buffer1904 = device190.createBuffer({
        label: "buffer1904",
        size: 400,
        usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ
    });
    const render_pipeline19014 = device190.createRenderPipeline({
        label: "render_pipeline19014",
        vertex: {
            module: shader_module1903,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19015 = device190.createRenderPipeline({
        label: "render_pipeline19015",
        vertex: {
            module: shader_module1903,
            entryPoint: "vertex_main",
            buffers: [
    ...
    buffer1904.destroy()
    const render_pipeline19016 = device190.createRenderPipeline({
        label: "render_pipeline19016",
        vertex: {
            module: shader_module1904,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19017 = device190.createRenderPipeline({
        label: "render_pipeline19017",
        vertex: {
            module: shader_module1904,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19018 = device190.createRenderPipeline({
        label: "render_pipeline19018",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    var shader_module1905_code = "";
    try {
        shader_module1905_code = await fs.readFile(__dirname + '/render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module1905 = await device190.createShaderModule({ label: "shader_module1905", code: shader_module1905_code })
    ...
    const render_pipeline19019 = device190.createRenderPipeline({
        label: "render_pipeline19019",
        vertex: {
    ...
    const query2302 = device230.createQuerySet({
        label: "query2302",
        type: "occlusion",
        count: 32,
    });
    ...
    device240.pushErrorScope("out-of-memory");
    ...
    const buffer1905 = device190.createBuffer({
        label: "buffer1905",
        size: 400,
        usage: GPUBufferUsage.COPY_SRC | GPUBufferUsage.MAP_WRITE
    });
    var shader_module1906_code = "";
    try {
        shader_module1906_code = await fs.readFile(__dirname + '/render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module1906 = await device190.createShaderModule({ label: "shader_module1906", code: shader_module1906_code })
    ...
    const buffer1906 = device190.createBuffer({
        label: "buffer1906",
        size: 400,
        usage: GPUBufferUsage.VERTEX
    });
    const buffer1907 = device190.createBuffer({
        label: "buffer1907",
        size: 400,
        usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ
    });
    ...
    const render_pipeline19020 = device190.createRenderPipeline({
        label: "render_pipeline19020",
        vertex: {
            module: shader_module1904,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19021 = device190.createRenderPipeline({
        label: "render_pipeline19021",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19022 = device190.createRenderPipeline({
        label: "render_pipeline19022",
        vertex: {
            module: shader_module1904,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19023 = device190.createRenderPipeline({
        label: "render_pipeline19023",
        vertex: {
            module: shader_module1901,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19024 = device190.createRenderPipeline({
        label: "render_pipeline19024",
        vertex: {
            module: shader_module1901,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const buffer1908 = device190.createBuffer({
        label: "buffer1908",
        size: 400,
        usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ
    });
    ...
    const render_pipeline19025 = device190.createRenderPipeline({
        label: "render_pipeline19025",
        vertex: {
            module: shader_module1906,
            entryPoint: "vertex_main",
            buffers: [
                {
                    attributes: [
    ...
    const query1907 = device190.createQuerySet({
        label: "query1907",
        type: "occlusion",
        count: 32,
    });
    ...
    const buffer1909 = device190.createBuffer({
        label: "buffer1909",
        size: 400,
        usage: GPUBufferUsage.QUERY_RESOLVE
    });
    const render_pipeline19026 = device190.createRenderPipeline({
        label: "render_pipeline19026",
        vertex: {
            module: shader_module1900,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19027 = device190.createRenderPipeline({
        label: "render_pipeline19027",
        vertex: {
            module: shader_module1902,
            entryPoint: "vertex_main",
            buffers: [
    ...
    const render_pipeline19028 = device190.createRenderPipeline({
        label: "render_pipeline19028",
        vertex: {
            module: shader_module1906,
            entryPoint: "vertex_main",
            buffers: [
    ...
    var shader_module1907_code = "";
    try {
        shader_module1907_code = await fs.readFile(__dirname + '/render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module1907 = await device190.createShaderModule({ label: "shader_module1907", code: shader_module1907_code })
    device240.popErrorScope().then((error) => {
        if (error) {
            console.error(`An error occurred: ${error.message}`);
        }

// {"0:0":[71,96,3,141,157,148,55,228,242,186,89,34,235,4,162,169,115,236,195,241,24,232,229,29,178,47,167,13,138,81,151,119,111,84,23,224,228,181,64,44,123,218,80,126,222,252,48,224,13,58,10,200,7,45,24,127,148,200,57,99,8,185,237,180]}
// Seed: 2519073797173920164
...
fn func_2(arg_0: bool, arg_1: f32) -> Struct_4 {
    ...
    let var_1 = arg_1;
    let var_2 = false;
    let var_3 = global0[min(max(9322u - global3.a.x, u_input.c.x), ~u_input.b)];
    return global0[~1u];
}
...
fn func_3(arg_0: vec3<u32>, arg_1: Struct_4, arg_2: vec2<bool>, arg_3: Struct_4) -> Struct_3 {
    ...
    let var_3 = (((vec2<u32>(18480u, arg_3.d.b.b.x) % reverseBits(u_input.c)) << ((arg_0.yx % vec2<u32>(global3.a.x, arg_0.x)) << ~vec2<u32>(arg_1.b.b.x, arg_1.b.b.x))) % arg_1.d.b.b.wx) << (vec2<u32>(arg_0.x, dot(~vec3<u32>(58751u, var_1.a.x, var_1.a.x), ~vec3<u32>(8345u, u_input.c.x, 1u))) >> (vec2<u32>(func_2(arg_1.c.x, -123f).d.b.b.x, 1u) + (u_input.d.xz ^ (arg_0.zz >> arg_3.d.b.b.yx))));
    return Struct_3(vec2<u32>(abs(dot(~var_1.a, abs(global3.a))), u_input.c.x));
}
...
fn func_1(arg_0: Struct_4, arg_1: vec3<bool>, arg_2: f32, arg_3: vec4<i32>) -> vec3<bool> {
    ...
    var var_0 = arg_3.wyy / arg_3.yzy;
    global3 = func_3(arg_0.d.b.b.yyx, func_2(arg_0.b.d, -abs(398f) / arg_2), arg_0.b.c.zx, Struct_4(select(vec3<bool>(false, arg_0.c.x, !arg_1.x), vec3<bool>(!true, func_2(false, arg_2).d.b.d, all(arg_1.zz)), !func_2(arg_1.x, arg_2).d.b.c), Struct_1(vec4<i32>(2147483647i, 1i, 0i, arg_0.d.e) / firstLeadingBit(arg_0.d.b.a), arg_0.b.b, vec3<bool>(false & false, arg_0.b.c.x, 23814i == -1i), ~0u != 51886u), arg_0.c, func_2(false, step(arg_2, arg_2)).d));
    global3 = Struct_3(arg_0.d.b.b.wy * vec2<u32>(firstLeadingBit(dot(vec4<u32>(arg_0.b.b.x, 0u, global3.a.x, u_input.b), vec4<u32>(global3.a.x, 0u, u_input.c.x, global3.a.x))), arg_0.b.b.x - ~global3.a.x));
    var var_1 = dot(firstTrailingBit(~vec2<i32>(var_0.x, ~arg_0.b.a.x)), (var_0.xz * arg_3.yy) % vec2<i32>(25523i, func_2(arg_0.d.d, 905f).b.a.x));
    return func_2(~((arg_0.b.b.x * 39361u) >> abs(arg_0.d.b.b.x)) < (32355u << (91803u << ~global3.a.x)), step(arg_2, max(ceil(-520f) - -203f, -1000f * (-765f * arg_2)))).b.c;
}
...
fn func_4(arg_0: Struct_4, arg_1: Struct_2, arg_2: i32) -> Struct_3 {
    ...
    var var_2 = 1u;
    global1 = array<i32, 1>();
    var var_3 = Struct_2(select((-vec3<i32>(-1i, 31564i, i32(-2147483648)) % select(vec3<i32>(arg_1.b.a.x, 1i, var_0.x), var_0, true)) ^ var_0, -var_0 % -(var_0 ^ arg_1.a), vec3<bool>(!any(vec3<bool>(true, true, var_1.x)), all(arg_0.c), func_3(arg_0.b.b.yyz, Struct_4(vec3<bool>(false, false, var_1.x), Struct_1(vec4<i32>(arg_2, -11695i, -54594i, 2147483647i), arg_1.b.b, vec3<bool>(arg_1.d, var_1.x, false), true), arg_0.c, Struct_2(arg_0.b.a.yyw, Struct_1(arg_0.b.a, vec4<u32>(4294967295u, 1u, 637u, u_input.b), arg_1.b.c, false), global1[u_input.c.x], var_1.x, 2147483647i)), vec2<bool>(true, arg_0.a.x), Struct_4(vec3<bool>(arg_0.d.d, true, var_1.x), Struct_1(arg_0.b.a, vec4<u32>(22451u, 4294967295u, u_input.d.x, 44587u), vec3<bool>(false, arg_0.c.x, var_1.x), arg_1.b.c.x), vec4<bool>(arg_1.d, arg_0.b.d, true, var_1.x), arg_0.d)).a.x >= arg_1.b.b.x)), func_2(any(func_2(arg_0.b.d, 571f * 702f).c), trunc(-1245f)).d.b, ~(-(arg_1.e + -arg_0.b.a.x)), false != all(!arg_1.b.c), ~dot(~arg_0.d.a % vec3<i32>(arg_1.a.x, u_input.e.x, global1[7064u]), -(arg_0.d.b.a.zzz - arg_1.a)));
    return Struct_3(~firstTrailingBit(var_3.b.b.xx / func_3(vec3<u32>(u_input.c.x, var_3.b.b.x, 4294967295u), Struct_4(vec3<bool>(true, true, true), arg_1.b, arg_0.c, arg_1), var_1, arg_0).a));
}
...
fn main() {
    ...
    global3 = func_4(Struct_4(select(select(vec3<bool>(var_0, true, false), !vec3<bool>(true, false, true), 196f != 590f), func_1(Struct_4(vec3<bool>(false, var_0, var_0), Struct_1(vec4<i32>(0i, -1i, global1[4294967295u], -2081i), vec4<u32>(34742u, global3.a.x, u_input.d.x, global3.a.x), vec3<bool>(var_0, true, false), var_0), vec4<bool>(var_0, true, var_0, var_0), Struct_2(vec3<i32>(1i, -78229i, -25241i), Struct_1(vec4<i32>(global1[u_input.d.x], u_input.a.x, -5575i, global1[78263u]), vec4<u32>(0u, 4294967295u, u_input.d.x, 0u), vec3<bool>(true, var_0, true), false), global1[1u], var_0, 27095i)), !vec3<bool>(false, false, var_0), 575f / -547f, vec4<i32>(-200i, i32(-2147483648), global1[global3.a.x], u_input.e.x) * vec4<i32>(global1[0u], 32804i, 16667i, global1[u_input.c.x])), var_0), func_2(true, 105f - (771f - 623f)).b, func_2(var_0, 1000f * (-276f * 768f)).c, Struct_2(abs(vec3<i32>(u_input.a.x, 74059i, u_input.e.x)) << min(u_input.d, vec3<u32>(21401u, 4074u, 0u)), func_2(var_0, floor(855f)).b, -u_input.e.x, var_0, -u_input.a.x)), func_2(var_0, ((954f - 1048f) * -2061f) / -960f).d, 1680i);
    var var_1 = ~0u;
    let var_2 = global0[1u];
    global1 = array<i32, 1>();
    var var_3 = Struct_2(var_2.d.a, func_2(!any(vec3<bool>(false, true, var_0)), step(-959f, -1146f)).b, ~(-(-10989i)), all(vec3<bool>(!false, all(var_2.b.c), !(var_0 || true))), -var_2.d.b.a.x);
    var_3 = var_2.d;
    let var_4 = var_3.b.c.x & (var_3.b.d && false);
    let x = u_input.a;
    s_output = StorageBuffer(sign(trunc(select(vec3<f32>(273f, 848f, -1000f), vec3<f32>(-2139f, 137f, -240f), vec3<bool>(false, false, var_3.b.d))) * -sign(vec3<f32>(1403f, -100f, 2420f))));
}

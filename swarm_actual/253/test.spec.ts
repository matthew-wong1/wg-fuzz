...
async function main(gpu: GPU) {
    ...
    try {
        shader_module1402_code = await fs.readFile(__dirname + '/render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const texture_view10023 = texture1002.createView({ label: "texture_view10023" });
    ...
    const texture_view10040 = texture1004.createView({ label: "texture_view10040" });
